...
public class DescribeLayoutFeedView implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setFeedFilters(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("feedFilters", "urn:enterprise.soap.sforce.com","feedFilters","urn:enterprise.soap.sforce.com","DescribeLayoutFeedFilter",0,-1,true))) {
        setFeedFilters((com.sforce.soap.enterprise.DescribeLayoutFeedFilter[])__typeMapper.readObject(__in, _lookupTypeInfo("feedFilters", "urn:enterprise.soap.sforce.com","feedFilters","urn:enterprise.soap.sforce.com","DescribeLayoutFeedFilter",0,-1,true), com.sforce.soap.enterprise.DescribeLayoutFeedFilter[].class));
      }
    }
    ...
    private void writeFieldFeedFilters(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("feedFilters", "urn:enterprise.soap.sforce.com","feedFilters","urn:enterprise.soap.sforce.com","DescribeLayoutFeedFilter",0,-1,true), feedFilters, feedFilters__is_set);
    }
