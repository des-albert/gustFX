...
public class ProcessResponse_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setResult(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("result", "urn:enterprise.soap.sforce.com","result","urn:enterprise.soap.sforce.com","ProcessResult",0,-1,true))) {
        setResult((com.sforce.soap.enterprise.ProcessResult[])__typeMapper.readObject(__in, _lookupTypeInfo("result", "urn:enterprise.soap.sforce.com","result","urn:enterprise.soap.sforce.com","ProcessResult",0,-1,true), com.sforce.soap.enterprise.ProcessResult[].class));
      }
    }
    ...
    private void writeFieldResult(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("result", "urn:enterprise.soap.sforce.com","result","urn:enterprise.soap.sforce.com","ProcessResult",0,-1,true), result, result__is_set);
    }
