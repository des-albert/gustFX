...
public class PicklistEntry implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setValidFor(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("validFor", "urn:enterprise.soap.sforce.com","validFor","http://www.w3.org/2001/XMLSchema","base64Binary",0,1,true))) {
        setValidFor((byte[])__typeMapper.readObject(__in, _lookupTypeInfo("validFor", "urn:enterprise.soap.sforce.com","validFor","http://www.w3.org/2001/XMLSchema","base64Binary",0,1,true), byte[].class));
      }
    }
    ...
    private void writeFieldValidFor(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("validFor", "urn:enterprise.soap.sforce.com","validFor","http://www.w3.org/2001/XMLSchema","base64Binary",0,1,true), validFor, validFor__is_set);
    }
