...
public class RenderEmailTemplateBodyResult implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setErrors(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("errors", "urn:enterprise.soap.sforce.com","errors","urn:enterprise.soap.sforce.com","RenderEmailTemplateError",0,-1,true))) {
        setErrors((com.sforce.soap.enterprise.RenderEmailTemplateError[])__typeMapper.readObject(__in, _lookupTypeInfo("errors", "urn:enterprise.soap.sforce.com","errors","urn:enterprise.soap.sforce.com","RenderEmailTemplateError",0,-1,true), com.sforce.soap.enterprise.RenderEmailTemplateError[].class));
      }
    }
    ...
    private void writeFieldErrors(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("errors", "urn:enterprise.soap.sforce.com","errors","urn:enterprise.soap.sforce.com","RenderEmailTemplateError",0,-1,true), errors, errors__is_set);
    }
    ...
    protected void setMergedBody(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("mergedBody", "urn:enterprise.soap.sforce.com","mergedBody","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setMergedBody(__typeMapper.readString(__in, _lookupTypeInfo("mergedBody", "urn:enterprise.soap.sforce.com","mergedBody","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }

    private void writeFieldMergedBody(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("mergedBody", "urn:enterprise.soap.sforce.com","mergedBody","http://www.w3.org/2001/XMLSchema","string",1,1,true), mergedBody, mergedBody__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldMergedBody(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setMergedBody(__in, __typeMapper);
      setSuccess(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "errors", errors);
      toStringHelper(sb, "mergedBody", mergedBody);
