...
public class SoqlConditionGroup extends com.sforce.soap.enterprise.SoqlWhereCondition {
    ...
    protected void setConditions(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("conditions", "urn:enterprise.soap.sforce.com","conditions","urn:enterprise.soap.sforce.com","SoqlWhereCondition",0,-1,true))) {
        setConditions((com.sforce.soap.enterprise.SoqlWhereCondition[])__typeMapper.readObject(__in, _lookupTypeInfo("conditions", "urn:enterprise.soap.sforce.com","conditions","urn:enterprise.soap.sforce.com","SoqlWhereCondition",0,-1,true), com.sforce.soap.enterprise.SoqlWhereCondition[].class));
      }
    }
    ...
    private void writeFieldConditions(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("conditions", "urn:enterprise.soap.sforce.com","conditions","urn:enterprise.soap.sforce.com","SoqlWhereCondition",0,-1,true), conditions, conditions__is_set);
    }
    ...
    protected void setConjunction(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("conjunction", "urn:enterprise.soap.sforce.com","conjunction","urn:enterprise.soap.sforce.com","soqlConjunction",1,1,true))) {
        setConjunction((com.sforce.soap.enterprise.SoqlConjunction)__typeMapper.readObject(__in, _lookupTypeInfo("conjunction", "urn:enterprise.soap.sforce.com","conjunction","urn:enterprise.soap.sforce.com","soqlConjunction",1,1,true), com.sforce.soap.enterprise.SoqlConjunction.class));
      }
    }
    ...
    private void writeFieldConjunction(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("conjunction", "urn:enterprise.soap.sforce.com","conjunction","urn:enterprise.soap.sforce.com","soqlConjunction",1,1,true), conjunction, conjunction__is_set);
    }
