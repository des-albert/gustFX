 ...
 */
public class RenderStoredEmailTemplateResult implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * element : renderedEmail of type {urn:enterprise.soap.sforce.com}SingleEmailMessage
     * java type: com.sforce.soap.enterprise.SingleEmailMessage
     */
    private boolean renderedEmail__is_set = false;

    private com.sforce.soap.enterprise.SingleEmailMessage renderedEmail;

    public com.sforce.soap.enterprise.SingleEmailMessage getRenderedEmail() {
      return renderedEmail;
    }

    public void setRenderedEmail(com.sforce.soap.enterprise.SingleEmailMessage renderedEmail) {
      this.renderedEmail = renderedEmail;
      renderedEmail__is_set = true;
    }

    protected void setRenderedEmail(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("renderedEmail", "urn:enterprise.soap.sforce.com","renderedEmail","urn:enterprise.soap.sforce.com","SingleEmailMessage",1,1,true))) {
        setRenderedEmail((com.sforce.soap.enterprise.SingleEmailMessage)__typeMapper.readObject(__in, _lookupTypeInfo("renderedEmail", "urn:enterprise.soap.sforce.com","renderedEmail","urn:enterprise.soap.sforce.com","SingleEmailMessage",1,1,true), com.sforce.soap.enterprise.SingleEmailMessage.class));
      }
    }

    private void writeFieldRenderedEmail(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("renderedEmail", "urn:enterprise.soap.sforce.com","renderedEmail","urn:enterprise.soap.sforce.com","SingleEmailMessage",1,1,true), renderedEmail, renderedEmail__is_set);
    }
    ...
    public String toString() {
      ...
      sb.append("[RenderStoredEmailTemplateResult ");
      toString1(sb);
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldRenderedEmail(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setRenderedEmail(__in, __typeMapper);
      setSuccess(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "errors", errors);
      toStringHelper(sb, "renderedEmail", renderedEmail);
