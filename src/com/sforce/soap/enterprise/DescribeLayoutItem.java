...
public class DescribeLayoutItem implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setEditableForNew(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("editableForNew", "urn:enterprise.soap.sforce.com","editableForNew","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setEditableForNew(__typeMapper.readBoolean(__in, _lookupTypeInfo("editableForNew", "urn:enterprise.soap.sforce.com","editableForNew","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldEditableForNew(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("editableForNew", "urn:enterprise.soap.sforce.com","editableForNew","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), editableForNew, editableForNew__is_set);
    }
    ...
    protected void setEditableForUpdate(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("editableForUpdate", "urn:enterprise.soap.sforce.com","editableForUpdate","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setEditableForUpdate(__typeMapper.readBoolean(__in, _lookupTypeInfo("editableForUpdate", "urn:enterprise.soap.sforce.com","editableForUpdate","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldEditableForUpdate(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("editableForUpdate", "urn:enterprise.soap.sforce.com","editableForUpdate","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), editableForUpdate, editableForUpdate__is_set);
    }
    ...
    protected void setLayoutComponents(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("layoutComponents", "urn:enterprise.soap.sforce.com","layoutComponents","urn:enterprise.soap.sforce.com","DescribeLayoutComponent",0,-1,true))) {
        setLayoutComponents((com.sforce.soap.enterprise.DescribeLayoutComponent[])__typeMapper.readObject(__in, _lookupTypeInfo("layoutComponents", "urn:enterprise.soap.sforce.com","layoutComponents","urn:enterprise.soap.sforce.com","DescribeLayoutComponent",0,-1,true), com.sforce.soap.enterprise.DescribeLayoutComponent[].class));
      }
    }
    ...
    private void writeFieldLayoutComponents(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("layoutComponents", "urn:enterprise.soap.sforce.com","layoutComponents","urn:enterprise.soap.sforce.com","DescribeLayoutComponent",0,-1,true), layoutComponents, layoutComponents__is_set);
    }
    ...
    protected void setPlaceholder(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("placeholder", "urn:enterprise.soap.sforce.com","placeholder","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setPlaceholder(__typeMapper.readBoolean(__in, _lookupTypeInfo("placeholder", "urn:enterprise.soap.sforce.com","placeholder","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldPlaceholder(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("placeholder", "urn:enterprise.soap.sforce.com","placeholder","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), placeholder, placeholder__is_set);
    }
