...
public class DescribePathAssistants_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setRecordTypeIds(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("recordTypeIds", "urn:enterprise.soap.sforce.com","recordTypeIds","urn:enterprise.soap.sforce.com","ID",0,-1,true))) {
        setRecordTypeIds((java.lang.String[])__typeMapper.readObject(__in, _lookupTypeInfo("recordTypeIds", "urn:enterprise.soap.sforce.com","recordTypeIds","urn:enterprise.soap.sforce.com","ID",0,-1,true), java.lang.String[].class));
      }
    }
    ...
    private void writeFieldRecordTypeIds(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("recordTypeIds", "urn:enterprise.soap.sforce.com","recordTypeIds","urn:enterprise.soap.sforce.com","ID",0,-1,true), recordTypeIds, recordTypeIds__is_set);
    }
