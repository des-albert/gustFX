 ...
 */
public class FlowRecordRelation extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public FlowRecordRelation() {}
    ...
    protected void setParent(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Parent", "urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","FlowInterview",0,1,true))) {
        setParent((com.sforce.soap.enterprise.sobject.FlowInterview)__typeMapper.readObject(__in, _lookupTypeInfo("Parent", "urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","FlowInterview",0,1,true), com.sforce.soap.enterprise.sobject.FlowInterview.class));
      }
    }
    ...
    private void writeFieldParent(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Parent", "urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","FlowInterview",0,1,true), Parent, Parent__is_set);
    }
    ...
    /**
     * element : RelatedRecord of type {urn:sobject.enterprise.soap.sforce.com}Contract
     * java type: com.sforce.soap.enterprise.sobject.Contract
     */
    private boolean RelatedRecord__is_set = false;

    private com.sforce.soap.enterprise.sobject.Contract RelatedRecord;

    public com.sforce.soap.enterprise.sobject.Contract getRelatedRecord() {
      return RelatedRecord;
    }

    public void setRelatedRecord(com.sforce.soap.enterprise.sobject.Contract RelatedRecord) {
    ...
    protected void setRelatedRecord(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("RelatedRecord", "urn:sobject.enterprise.soap.sforce.com","RelatedRecord","urn:sobject.enterprise.soap.sforce.com","Contract",0,1,true))) {
        setRelatedRecord((com.sforce.soap.enterprise.sobject.Contract)__typeMapper.readObject(__in, _lookupTypeInfo("RelatedRecord", "urn:sobject.enterprise.soap.sforce.com","RelatedRecord","urn:sobject.enterprise.soap.sforce.com","Contract",0,1,true), com.sforce.soap.enterprise.sobject.Contract.class));
      }
    }
    ...
    private void writeFieldRelatedRecord(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("RelatedRecord", "urn:sobject.enterprise.soap.sforce.com","RelatedRecord","urn:sobject.enterprise.soap.sforce.com","Contract",0,1,true), RelatedRecord, RelatedRecord__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "FlowRecordRelation");
