...
public class FeedPollChoice extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setChoiceBody(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ChoiceBody", "urn:sobject.enterprise.soap.sforce.com","ChoiceBody","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setChoiceBody(__typeMapper.readString(__in, _lookupTypeInfo("ChoiceBody", "urn:sobject.enterprise.soap.sforce.com","ChoiceBody","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldChoiceBody(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ChoiceBody", "urn:sobject.enterprise.soap.sforce.com","ChoiceBody","http://www.w3.org/2001/XMLSchema","string",0,1,true), ChoiceBody, ChoiceBody__is_set);
    }
    ...
    protected void setFeedPollVotes(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FeedPollVotes", "urn:sobject.enterprise.soap.sforce.com","FeedPollVotes","urn:enterprise.soap.sforce.com","QueryResult",0,1,true))) {
        setFeedPollVotes((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("FeedPollVotes", "urn:sobject.enterprise.soap.sforce.com","FeedPollVotes","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.enterprise.QueryResult.class));
      }
    }

    private void writeFieldFeedPollVotes(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FeedPollVotes", "urn:sobject.enterprise.soap.sforce.com","FeedPollVotes","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), FeedPollVotes, FeedPollVotes__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldChoiceBody(__out, __typeMapper);
      ...
      writeFieldFeedPollVotes(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setChoiceBody(__in, __typeMapper);
      ...
      setFeedPollVotes(__in, __typeMapper);
      setIsDeleted(__in, __typeMapper);
      setPosition(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "ChoiceBody", ChoiceBody);
      ...
      toStringHelper(sb, "FeedPollVotes", FeedPollVotes);
