 ...
 */
public class LightningComponentResource extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setFilePath(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FilePath", "urn:sobject.enterprise.soap.sforce.com","FilePath","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setFilePath(__typeMapper.readString(__in, _lookupTypeInfo("FilePath", "urn:sobject.enterprise.soap.sforce.com","FilePath","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldFilePath(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FilePath", "urn:sobject.enterprise.soap.sforce.com","FilePath","http://www.w3.org/2001/XMLSchema","string",0,1,true), FilePath, FilePath__is_set);
    }
    ...
    /**
     * element : LightningComponentBundle of type {urn:sobject.enterprise.soap.sforce.com}LightningComponentBundle
     * java type: com.sforce.soap.enterprise.sobject.LightningComponentBundle
     */
    private boolean LightningComponentBundle__is_set = false;

    private com.sforce.soap.enterprise.sobject.LightningComponentBundle LightningComponentBundle;

    public com.sforce.soap.enterprise.sobject.LightningComponentBundle getLightningComponentBundle() {
      return LightningComponentBundle;
    }

    public void setLightningComponentBundle(com.sforce.soap.enterprise.sobject.LightningComponentBundle LightningComponentBundle) {
    ...
    protected void setLightningComponentBundle(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LightningComponentBundle", "urn:sobject.enterprise.soap.sforce.com","LightningComponentBundle","urn:sobject.enterprise.soap.sforce.com","LightningComponentBundle",0,1,true))) {
        setLightningComponentBundle((com.sforce.soap.enterprise.sobject.LightningComponentBundle)__typeMapper.readObject(__in, _lookupTypeInfo("LightningComponentBundle", "urn:sobject.enterprise.soap.sforce.com","LightningComponentBundle","urn:sobject.enterprise.soap.sforce.com","LightningComponentBundle",0,1,true), com.sforce.soap.enterprise.sobject.LightningComponentBundle.class));
      }
    }
    ...
    private void writeFieldLightningComponentBundle(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LightningComponentBundle", "urn:sobject.enterprise.soap.sforce.com","LightningComponentBundle","urn:sobject.enterprise.soap.sforce.com","LightningComponentBundle",0,1,true), LightningComponentBundle, LightningComponentBundle__is_set);
    }
    ...
    protected void setLightningComponentBundleId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LightningComponentBundleId", "urn:sobject.enterprise.soap.sforce.com","LightningComponentBundleId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setLightningComponentBundleId(__typeMapper.readString(__in, _lookupTypeInfo("LightningComponentBundleId", "urn:sobject.enterprise.soap.sforce.com","LightningComponentBundleId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldLightningComponentBundleId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LightningComponentBundleId", "urn:sobject.enterprise.soap.sforce.com","LightningComponentBundleId","urn:enterprise.soap.sforce.com","ID",0,1,true), LightningComponentBundleId, LightningComponentBundleId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "LightningComponentResource");
