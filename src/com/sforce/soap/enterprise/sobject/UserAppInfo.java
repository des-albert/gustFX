...
public class UserAppInfo extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setFormFactor(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FormFactor", "urn:sobject.enterprise.soap.sforce.com","FormFactor","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setFormFactor(__typeMapper.readString(__in, _lookupTypeInfo("FormFactor", "urn:sobject.enterprise.soap.sforce.com","FormFactor","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldFormFactor(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FormFactor", "urn:sobject.enterprise.soap.sforce.com","FormFactor","http://www.w3.org/2001/XMLSchema","string",0,1,true), FormFactor, FormFactor__is_set);
    }
