...
public class InstalledMobileApp extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setConnectedApplication(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ConnectedApplication", "urn:sobject.enterprise.soap.sforce.com","ConnectedApplication","urn:sobject.enterprise.soap.sforce.com","ConnectedApplication",0,1,true))) {
        setConnectedApplication((com.sforce.soap.enterprise.sobject.ConnectedApplication)__typeMapper.readObject(__in, _lookupTypeInfo("ConnectedApplication", "urn:sobject.enterprise.soap.sforce.com","ConnectedApplication","urn:sobject.enterprise.soap.sforce.com","ConnectedApplication",0,1,true), com.sforce.soap.enterprise.sobject.ConnectedApplication.class));
      }
    }

    private void writeFieldConnectedApplication(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ConnectedApplication", "urn:sobject.enterprise.soap.sforce.com","ConnectedApplication","urn:sobject.enterprise.soap.sforce.com","ConnectedApplication",0,1,true), ConnectedApplication, ConnectedApplication__is_set);
    }
    ...
    protected void setConnectedApplicationId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ConnectedApplicationId", "urn:sobject.enterprise.soap.sforce.com","ConnectedApplicationId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setConnectedApplicationId(__typeMapper.readString(__in, _lookupTypeInfo("ConnectedApplicationId", "urn:sobject.enterprise.soap.sforce.com","ConnectedApplicationId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldConnectedApplicationId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ConnectedApplicationId", "urn:sobject.enterprise.soap.sforce.com","ConnectedApplicationId","urn:enterprise.soap.sforce.com","ID",0,1,true), ConnectedApplicationId, ConnectedApplicationId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldConnectedApplication(__out, __typeMapper);
      writeFieldConnectedApplicationId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setConnectedApplication(__in, __typeMapper);
      setConnectedApplicationId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "ConnectedApplication", ConnectedApplication);
      toStringHelper(sb, "ConnectedApplicationId", ConnectedApplicationId);
