...
public class DuplicateRecordItem extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setDuplicateRecordSet(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("DuplicateRecordSet", "urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet","urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet",0,1,true))) {
        setDuplicateRecordSet((com.sforce.soap.enterprise.sobject.DuplicateRecordSet)__typeMapper.readObject(__in, _lookupTypeInfo("DuplicateRecordSet", "urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet","urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet",0,1,true), com.sforce.soap.enterprise.sobject.DuplicateRecordSet.class));
      }
    }

    private void writeFieldDuplicateRecordSet(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("DuplicateRecordSet", "urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet","urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet",0,1,true), DuplicateRecordSet, DuplicateRecordSet__is_set);
    }
    ...
    protected void setDuplicateRecordSetId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("DuplicateRecordSetId", "urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSetId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setDuplicateRecordSetId(__typeMapper.readString(__in, _lookupTypeInfo("DuplicateRecordSetId", "urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSetId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldDuplicateRecordSetId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("DuplicateRecordSetId", "urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSetId","urn:enterprise.soap.sforce.com","ID",0,1,true), DuplicateRecordSetId, DuplicateRecordSetId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldDuplicateRecordSet(__out, __typeMapper);
      writeFieldDuplicateRecordSetId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setDuplicateRecordSet(__in, __typeMapper);
      setDuplicateRecordSetId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "DuplicateRecordSet", DuplicateRecordSet);
      toStringHelper(sb, "DuplicateRecordSetId", DuplicateRecordSetId);
