 ...
 */
public class QuickTextHistory extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : QuickText of type {urn:sobject.enterprise.soap.sforce.com}QuickText
     * java type: com.sforce.soap.enterprise.sobject.QuickText
     */
    private boolean QuickText__is_set = false;
    ...
    public void setQuickText(com.sforce.soap.enterprise.sobject.QuickText QuickText) {
      ...
      QuickText__is_set = true;
    }

    protected void setQuickText(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("QuickText", "urn:sobject.enterprise.soap.sforce.com","QuickText","urn:sobject.enterprise.soap.sforce.com","QuickText",0,1,true))) {
        setQuickText((com.sforce.soap.enterprise.sobject.QuickText)__typeMapper.readObject(__in, _lookupTypeInfo("QuickText", "urn:sobject.enterprise.soap.sforce.com","QuickText","urn:sobject.enterprise.soap.sforce.com","QuickText",0,1,true), com.sforce.soap.enterprise.sobject.QuickText.class));
      }
    }

    private void writeFieldQuickText(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("QuickText", "urn:sobject.enterprise.soap.sforce.com","QuickText","urn:sobject.enterprise.soap.sforce.com","QuickText",0,1,true), QuickText, QuickText__is_set);
    }

    /**
     * element : QuickTextId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean QuickTextId__is_set = false;
    ...
    public void setQuickTextId(java.lang.String QuickTextId) {
      ...
      QuickTextId__is_set = true;
    }

    protected void setQuickTextId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("QuickTextId", "urn:sobject.enterprise.soap.sforce.com","QuickTextId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setQuickTextId(__typeMapper.readString(__in, _lookupTypeInfo("QuickTextId", "urn:sobject.enterprise.soap.sforce.com","QuickTextId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldQuickTextId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("QuickTextId", "urn:sobject.enterprise.soap.sforce.com","QuickTextId","urn:enterprise.soap.sforce.com","ID",0,1,true), QuickTextId, QuickTextId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "QuickTextHistory");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldQuickText(__out, __typeMapper);
      writeFieldQuickTextId(__out, __typeMapper);
    }
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setQuickText(__in, __typeMapper);
      setQuickTextId(__in, __typeMapper);
    }
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "QuickText", QuickText);
      toStringHelper(sb, "QuickTextId", QuickTextId);
    }
