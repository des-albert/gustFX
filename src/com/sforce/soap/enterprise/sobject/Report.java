...
public class Report extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setLastRunDate(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LastRunDate", "urn:sobject.enterprise.soap.sforce.com","LastRunDate","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true))) {
        setLastRunDate((java.util.Calendar)__typeMapper.readObject(__in, _lookupTypeInfo("LastRunDate", "urn:sobject.enterprise.soap.sforce.com","LastRunDate","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true), java.util.Calendar.class));
      }
    }

    private void writeFieldLastRunDate(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LastRunDate", "urn:sobject.enterprise.soap.sforce.com","LastRunDate","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true), LastRunDate, LastRunDate__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldLastRunDate(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setLastRunDate(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "LastRunDate", LastRunDate);
