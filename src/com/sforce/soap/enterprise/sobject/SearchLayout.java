...
public class SearchLayout extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setButtonsDisplayed(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ButtonsDisplayed", "urn:sobject.enterprise.soap.sforce.com","ButtonsDisplayed","urn:enterprise.soap.sforce.com","SearchLayoutButtonsDisplayed",0,1,true))) {
        setButtonsDisplayed((com.sforce.soap.enterprise.SearchLayoutButtonsDisplayed)__typeMapper.readObject(__in, _lookupTypeInfo("ButtonsDisplayed", "urn:sobject.enterprise.soap.sforce.com","ButtonsDisplayed","urn:enterprise.soap.sforce.com","SearchLayoutButtonsDisplayed",0,1,true), com.sforce.soap.enterprise.SearchLayoutButtonsDisplayed.class));
      }
    }
    ...
    private void writeFieldButtonsDisplayed(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ButtonsDisplayed", "urn:sobject.enterprise.soap.sforce.com","ButtonsDisplayed","urn:enterprise.soap.sforce.com","SearchLayoutButtonsDisplayed",0,1,true), ButtonsDisplayed, ButtonsDisplayed__is_set);
    }
    ...
    protected void setFieldsDisplayed(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FieldsDisplayed", "urn:sobject.enterprise.soap.sforce.com","FieldsDisplayed","urn:enterprise.soap.sforce.com","SearchLayoutFieldsDisplayed",0,1,true))) {
        setFieldsDisplayed((com.sforce.soap.enterprise.SearchLayoutFieldsDisplayed)__typeMapper.readObject(__in, _lookupTypeInfo("FieldsDisplayed", "urn:sobject.enterprise.soap.sforce.com","FieldsDisplayed","urn:enterprise.soap.sforce.com","SearchLayoutFieldsDisplayed",0,1,true), com.sforce.soap.enterprise.SearchLayoutFieldsDisplayed.class));
      }
    }
    ...
    private void writeFieldFieldsDisplayed(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FieldsDisplayed", "urn:sobject.enterprise.soap.sforce.com","FieldsDisplayed","urn:enterprise.soap.sforce.com","SearchLayoutFieldsDisplayed",0,1,true), FieldsDisplayed, FieldsDisplayed__is_set);
    }
    ...
    protected void setLayoutType(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LayoutType", "urn:sobject.enterprise.soap.sforce.com","LayoutType","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setLayoutType(__typeMapper.readString(__in, _lookupTypeInfo("LayoutType", "urn:sobject.enterprise.soap.sforce.com","LayoutType","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldLayoutType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LayoutType", "urn:sobject.enterprise.soap.sforce.com","LayoutType","http://www.w3.org/2001/XMLSchema","string",0,1,true), LayoutType, LayoutType__is_set);
    }
