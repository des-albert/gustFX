...
public class Macro extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : IsAlohaSupported of type {http://www.w3.org/2001/XMLSchema}boolean
     * java type: java.lang.Boolean
     */
    private boolean IsAlohaSupported__is_set = false;

    private java.lang.Boolean IsAlohaSupported;

    public java.lang.Boolean getIsAlohaSupported() {
      return IsAlohaSupported;
    }

    public void setIsAlohaSupported(java.lang.Boolean IsAlohaSupported) {
      this.IsAlohaSupported = IsAlohaSupported;
      IsAlohaSupported__is_set = true;
    }

    protected void setIsAlohaSupported(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("IsAlohaSupported", "urn:sobject.enterprise.soap.sforce.com","IsAlohaSupported","http://www.w3.org/2001/XMLSchema","boolean",0,1,true))) {
        setIsAlohaSupported((java.lang.Boolean)__typeMapper.readObject(__in, _lookupTypeInfo("IsAlohaSupported", "urn:sobject.enterprise.soap.sforce.com","IsAlohaSupported","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), java.lang.Boolean.class));
      }
    }

    private void writeFieldIsAlohaSupported(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("IsAlohaSupported", "urn:sobject.enterprise.soap.sforce.com","IsAlohaSupported","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), IsAlohaSupported, IsAlohaSupported__is_set);
    }
    ...
    /**
     * element : IsLightningSupported of type {http://www.w3.org/2001/XMLSchema}boolean
     * java type: java.lang.Boolean
     */
    private boolean IsLightningSupported__is_set = false;

    private java.lang.Boolean IsLightningSupported;

    public java.lang.Boolean getIsLightningSupported() {
      return IsLightningSupported;
    }

    public void setIsLightningSupported(java.lang.Boolean IsLightningSupported) {
      this.IsLightningSupported = IsLightningSupported;
      IsLightningSupported__is_set = true;
    }

    protected void setIsLightningSupported(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("IsLightningSupported", "urn:sobject.enterprise.soap.sforce.com","IsLightningSupported","http://www.w3.org/2001/XMLSchema","boolean",0,1,true))) {
        setIsLightningSupported((java.lang.Boolean)__typeMapper.readObject(__in, _lookupTypeInfo("IsLightningSupported", "urn:sobject.enterprise.soap.sforce.com","IsLightningSupported","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), java.lang.Boolean.class));
      }
    }

    private void writeFieldIsLightningSupported(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("IsLightningSupported", "urn:sobject.enterprise.soap.sforce.com","IsLightningSupported","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), IsLightningSupported, IsLightningSupported__is_set);
    }
    ...
    /**
     * element : StartingContext of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private boolean StartingContext__is_set = false;

    private java.lang.String StartingContext;

    public java.lang.String getStartingContext() {
    ...
    public void setStartingContext(java.lang.String StartingContext) {
      ...
      StartingContext__is_set = true;
    }

    protected void setStartingContext(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("StartingContext", "urn:sobject.enterprise.soap.sforce.com","StartingContext","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setStartingContext(__typeMapper.readString(__in, _lookupTypeInfo("StartingContext", "urn:sobject.enterprise.soap.sforce.com","StartingContext","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldStartingContext(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("StartingContext", "urn:sobject.enterprise.soap.sforce.com","StartingContext","http://www.w3.org/2001/XMLSchema","string",0,1,true), StartingContext, StartingContext__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldIsAlohaSupported(__out, __typeMapper);
      writeFieldIsDeleted(__out, __typeMapper);
      writeFieldIsLightningSupported(__out, __typeMapper);
      ...
      writeFieldStartingContext(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setIsAlohaSupported(__in, __typeMapper);
      setIsDeleted(__in, __typeMapper);
      setIsLightningSupported(__in, __typeMapper);
      ...
      setStartingContext(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "IsAlohaSupported", IsAlohaSupported);
      toStringHelper(sb, "IsDeleted", IsDeleted);
      toStringHelper(sb, "IsLightningSupported", IsLightningSupported);
      ...
      toStringHelper(sb, "StartingContext", StartingContext);
