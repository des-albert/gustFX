...
public class UserListView extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setLastViewedChart(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LastViewedChart", "urn:sobject.enterprise.soap.sforce.com","LastViewedChart","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setLastViewedChart(__typeMapper.readString(__in, _lookupTypeInfo("LastViewedChart", "urn:sobject.enterprise.soap.sforce.com","LastViewedChart","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldLastViewedChart(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LastViewedChart", "urn:sobject.enterprise.soap.sforce.com","LastViewedChart","http://www.w3.org/2001/XMLSchema","string",0,1,true), LastViewedChart, LastViewedChart__is_set);
    }
    ...
    protected void setListView(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ListView", "urn:sobject.enterprise.soap.sforce.com","ListView","urn:sobject.enterprise.soap.sforce.com","ListView",0,1,true))) {
        setListView((com.sforce.soap.enterprise.sobject.ListView)__typeMapper.readObject(__in, _lookupTypeInfo("ListView", "urn:sobject.enterprise.soap.sforce.com","ListView","urn:sobject.enterprise.soap.sforce.com","ListView",0,1,true), com.sforce.soap.enterprise.sobject.ListView.class));
      }
    }

    private void writeFieldListView(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ListView", "urn:sobject.enterprise.soap.sforce.com","ListView","urn:sobject.enterprise.soap.sforce.com","ListView",0,1,true), ListView, ListView__is_set);
    }
    ...
    protected void setListViewId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ListViewId", "urn:sobject.enterprise.soap.sforce.com","ListViewId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setListViewId(__typeMapper.readString(__in, _lookupTypeInfo("ListViewId", "urn:sobject.enterprise.soap.sforce.com","ListViewId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldListViewId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ListViewId", "urn:sobject.enterprise.soap.sforce.com","ListViewId","urn:enterprise.soap.sforce.com","ID",0,1,true), ListViewId, ListViewId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldLastViewedChart(__out, __typeMapper);
      writeFieldListView(__out, __typeMapper);
      writeFieldListViewId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setLastViewedChart(__in, __typeMapper);
      setListView(__in, __typeMapper);
      setListViewId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "LastViewedChart", LastViewedChart);
      toStringHelper(sb, "ListView", ListView);
      toStringHelper(sb, "ListViewId", ListViewId);
