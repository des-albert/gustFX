...
public class CustomPermissionDependency extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setRequiredCustomPermission(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("RequiredCustomPermission", "urn:sobject.enterprise.soap.sforce.com","RequiredCustomPermission","urn:sobject.enterprise.soap.sforce.com","CustomPermission",0,1,true))) {
        setRequiredCustomPermission((com.sforce.soap.enterprise.sobject.CustomPermission)__typeMapper.readObject(__in, _lookupTypeInfo("RequiredCustomPermission", "urn:sobject.enterprise.soap.sforce.com","RequiredCustomPermission","urn:sobject.enterprise.soap.sforce.com","CustomPermission",0,1,true), com.sforce.soap.enterprise.sobject.CustomPermission.class));
      }
    }

    private void writeFieldRequiredCustomPermission(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("RequiredCustomPermission", "urn:sobject.enterprise.soap.sforce.com","RequiredCustomPermission","urn:sobject.enterprise.soap.sforce.com","CustomPermission",0,1,true), RequiredCustomPermission, RequiredCustomPermission__is_set);
    }
    ...
    protected void setRequiredCustomPermissionId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("RequiredCustomPermissionId", "urn:sobject.enterprise.soap.sforce.com","RequiredCustomPermissionId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setRequiredCustomPermissionId(__typeMapper.readString(__in, _lookupTypeInfo("RequiredCustomPermissionId", "urn:sobject.enterprise.soap.sforce.com","RequiredCustomPermissionId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldRequiredCustomPermissionId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("RequiredCustomPermissionId", "urn:sobject.enterprise.soap.sforce.com","RequiredCustomPermissionId","urn:enterprise.soap.sforce.com","ID",0,1,true), RequiredCustomPermissionId, RequiredCustomPermissionId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldRequiredCustomPermission(__out, __typeMapper);
      writeFieldRequiredCustomPermissionId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setRequiredCustomPermission(__in, __typeMapper);
      setRequiredCustomPermissionId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "RequiredCustomPermission", RequiredCustomPermission);
      toStringHelper(sb, "RequiredCustomPermissionId", RequiredCustomPermissionId);
