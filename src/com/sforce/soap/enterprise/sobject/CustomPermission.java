...
public class CustomPermission extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setCustomPermissionDependencyItem(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("CustomPermissionDependencyItem", "urn:sobject.enterprise.soap.sforce.com","CustomPermissionDependencyItem","urn:enterprise.soap.sforce.com","QueryResult",0,1,true))) {
        setCustomPermissionDependencyItem((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("CustomPermissionDependencyItem", "urn:sobject.enterprise.soap.sforce.com","CustomPermissionDependencyItem","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.enterprise.QueryResult.class));
      }
    }

    private void writeFieldCustomPermissionDependencyItem(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("CustomPermissionDependencyItem", "urn:sobject.enterprise.soap.sforce.com","CustomPermissionDependencyItem","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), CustomPermissionDependencyItem, CustomPermissionDependencyItem__is_set);
    }
    ...
    protected void setCustomPermissionItem(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("CustomPermissionItem", "urn:sobject.enterprise.soap.sforce.com","CustomPermissionItem","urn:enterprise.soap.sforce.com","QueryResult",0,1,true))) {
        setCustomPermissionItem((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("CustomPermissionItem", "urn:sobject.enterprise.soap.sforce.com","CustomPermissionItem","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.enterprise.QueryResult.class));
      }
    }

    private void writeFieldCustomPermissionItem(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("CustomPermissionItem", "urn:sobject.enterprise.soap.sforce.com","CustomPermissionItem","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), CustomPermissionItem, CustomPermissionItem__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldCustomPermissionDependencyItem(__out, __typeMapper);
      writeFieldCustomPermissionItem(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setCustomPermissionDependencyItem(__in, __typeMapper);
      setCustomPermissionItem(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "CustomPermissionDependencyItem", CustomPermissionDependencyItem);
      toStringHelper(sb, "CustomPermissionItem", CustomPermissionItem);
