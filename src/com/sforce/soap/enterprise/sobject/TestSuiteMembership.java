...
public class TestSuiteMembership extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setApexTestSuite(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ApexTestSuite", "urn:sobject.enterprise.soap.sforce.com","ApexTestSuite","urn:sobject.enterprise.soap.sforce.com","ApexTestSuite",0,1,true))) {
        setApexTestSuite((com.sforce.soap.enterprise.sobject.ApexTestSuite)__typeMapper.readObject(__in, _lookupTypeInfo("ApexTestSuite", "urn:sobject.enterprise.soap.sforce.com","ApexTestSuite","urn:sobject.enterprise.soap.sforce.com","ApexTestSuite",0,1,true), com.sforce.soap.enterprise.sobject.ApexTestSuite.class));
      }
    }
    ...
    private void writeFieldApexTestSuite(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ApexTestSuite", "urn:sobject.enterprise.soap.sforce.com","ApexTestSuite","urn:sobject.enterprise.soap.sforce.com","ApexTestSuite",0,1,true), ApexTestSuite, ApexTestSuite__is_set);
    }
    ...
    protected void setApexTestSuiteId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ApexTestSuiteId", "urn:sobject.enterprise.soap.sforce.com","ApexTestSuiteId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setApexTestSuiteId(__typeMapper.readString(__in, _lookupTypeInfo("ApexTestSuiteId", "urn:sobject.enterprise.soap.sforce.com","ApexTestSuiteId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldApexTestSuiteId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ApexTestSuiteId", "urn:sobject.enterprise.soap.sforce.com","ApexTestSuiteId","urn:enterprise.soap.sforce.com","ID",0,1,true), ApexTestSuiteId, ApexTestSuiteId__is_set);
    }
