...
public class CollaborationGroupMemberRequest extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setRequester(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Requester", "urn:sobject.enterprise.soap.sforce.com","Requester","urn:sobject.enterprise.soap.sforce.com","User",0,1,true))) {
        setRequester((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, _lookupTypeInfo("Requester", "urn:sobject.enterprise.soap.sforce.com","Requester","urn:sobject.enterprise.soap.sforce.com","User",0,1,true), com.sforce.soap.enterprise.sobject.User.class));
      }
    }

    private void writeFieldRequester(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Requester", "urn:sobject.enterprise.soap.sforce.com","Requester","urn:sobject.enterprise.soap.sforce.com","User",0,1,true), Requester, Requester__is_set);
    }
    ...
    protected void setRequesterId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("RequesterId", "urn:sobject.enterprise.soap.sforce.com","RequesterId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setRequesterId(__typeMapper.readString(__in, _lookupTypeInfo("RequesterId", "urn:sobject.enterprise.soap.sforce.com","RequesterId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldRequesterId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("RequesterId", "urn:sobject.enterprise.soap.sforce.com","RequesterId","urn:enterprise.soap.sforce.com","ID",0,1,true), RequesterId, RequesterId__is_set);
    }
    ...
    protected void setResponseMessage(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ResponseMessage", "urn:sobject.enterprise.soap.sforce.com","ResponseMessage","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setResponseMessage(__typeMapper.readString(__in, _lookupTypeInfo("ResponseMessage", "urn:sobject.enterprise.soap.sforce.com","ResponseMessage","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldResponseMessage(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ResponseMessage", "urn:sobject.enterprise.soap.sforce.com","ResponseMessage","http://www.w3.org/2001/XMLSchema","string",0,1,true), ResponseMessage, ResponseMessage__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldRequester(__out, __typeMapper);
      writeFieldRequesterId(__out, __typeMapper);
      writeFieldResponseMessage(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setRequester(__in, __typeMapper);
      setRequesterId(__in, __typeMapper);
      setResponseMessage(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "Requester", Requester);
      toStringHelper(sb, "RequesterId", RequesterId);
      toStringHelper(sb, "ResponseMessage", ResponseMessage);
