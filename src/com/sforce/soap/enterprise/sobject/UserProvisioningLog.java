...
public class UserProvisioningLog extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setDetails(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Details", "urn:sobject.enterprise.soap.sforce.com","Details","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setDetails(__typeMapper.readString(__in, _lookupTypeInfo("Details", "urn:sobject.enterprise.soap.sforce.com","Details","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldDetails(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Details", "urn:sobject.enterprise.soap.sforce.com","Details","http://www.w3.org/2001/XMLSchema","string",0,1,true), Details, Details__is_set);
    }
    ...
    protected void setUserProvisioningRequest(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("UserProvisioningRequest", "urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequest","urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequest",0,1,true))) {
        setUserProvisioningRequest((com.sforce.soap.enterprise.sobject.UserProvisioningRequest)__typeMapper.readObject(__in, _lookupTypeInfo("UserProvisioningRequest", "urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequest","urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequest",0,1,true), com.sforce.soap.enterprise.sobject.UserProvisioningRequest.class));
      }
    }

    private void writeFieldUserProvisioningRequest(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("UserProvisioningRequest", "urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequest","urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequest",0,1,true), UserProvisioningRequest, UserProvisioningRequest__is_set);
    }
    ...
    protected void setUserProvisioningRequestId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("UserProvisioningRequestId", "urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequestId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setUserProvisioningRequestId(__typeMapper.readString(__in, _lookupTypeInfo("UserProvisioningRequestId", "urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequestId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldUserProvisioningRequestId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("UserProvisioningRequestId", "urn:sobject.enterprise.soap.sforce.com","UserProvisioningRequestId","urn:enterprise.soap.sforce.com","ID",0,1,true), UserProvisioningRequestId, UserProvisioningRequestId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldUserProvisioningRequest(__out, __typeMapper);
      writeFieldUserProvisioningRequestId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setUserProvisioningRequest(__in, __typeMapper);
      setUserProvisioningRequestId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "UserProvisioningRequest", UserProvisioningRequest);
      toStringHelper(sb, "UserProvisioningRequestId", UserProvisioningRequestId);
