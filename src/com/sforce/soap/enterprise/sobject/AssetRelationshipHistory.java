 ...
 */
public class AssetRelationshipHistory extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : AssetRelationship of type {urn:sobject.enterprise.soap.sforce.com}AssetRelationship
     * java type: com.sforce.soap.enterprise.sobject.AssetRelationship
     */
    private boolean AssetRelationship__is_set = false;

    private com.sforce.soap.enterprise.sobject.AssetRelationship AssetRelationship;

    public com.sforce.soap.enterprise.sobject.AssetRelationship getAssetRelationship() {
      return AssetRelationship;
    }

    public void setAssetRelationship(com.sforce.soap.enterprise.sobject.AssetRelationship AssetRelationship) {
      this.AssetRelationship = AssetRelationship;
      AssetRelationship__is_set = true;
    }

    protected void setAssetRelationship(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AssetRelationship", "urn:sobject.enterprise.soap.sforce.com","AssetRelationship","urn:sobject.enterprise.soap.sforce.com","AssetRelationship",0,1,true))) {
        setAssetRelationship((com.sforce.soap.enterprise.sobject.AssetRelationship)__typeMapper.readObject(__in, _lookupTypeInfo("AssetRelationship", "urn:sobject.enterprise.soap.sforce.com","AssetRelationship","urn:sobject.enterprise.soap.sforce.com","AssetRelationship",0,1,true), com.sforce.soap.enterprise.sobject.AssetRelationship.class));
      }
    }

    private void writeFieldAssetRelationship(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AssetRelationship", "urn:sobject.enterprise.soap.sforce.com","AssetRelationship","urn:sobject.enterprise.soap.sforce.com","AssetRelationship",0,1,true), AssetRelationship, AssetRelationship__is_set);
    }

    /**
     * element : AssetRelationshipId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean AssetRelationshipId__is_set = false;

    private java.lang.String AssetRelationshipId;

    public java.lang.String getAssetRelationshipId() {
      return AssetRelationshipId;
    }

    public void setAssetRelationshipId(java.lang.String AssetRelationshipId) {
      this.AssetRelationshipId = AssetRelationshipId;
      AssetRelationshipId__is_set = true;
    }

    protected void setAssetRelationshipId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AssetRelationshipId", "urn:sobject.enterprise.soap.sforce.com","AssetRelationshipId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setAssetRelationshipId(__typeMapper.readString(__in, _lookupTypeInfo("AssetRelationshipId", "urn:sobject.enterprise.soap.sforce.com","AssetRelationshipId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldAssetRelationshipId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AssetRelationshipId", "urn:sobject.enterprise.soap.sforce.com","AssetRelationshipId","urn:enterprise.soap.sforce.com","ID",0,1,true), AssetRelationshipId, AssetRelationshipId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "AssetRelationshipHistory");
    ...
    public String toString() {
      ...
      sb.append("[AssetRelationshipHistory ");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldAssetRelationship(__out, __typeMapper);
      writeFieldAssetRelationshipId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setAssetRelationship(__in, __typeMapper);
      setAssetRelationshipId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "AssetRelationship", AssetRelationship);
      toStringHelper(sb, "AssetRelationshipId", AssetRelationshipId);
