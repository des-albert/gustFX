 ...
 */
public class OrderItemHistory extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : OrderItem of type {urn:sobject.enterprise.soap.sforce.com}OrderItem
     * java type: com.sforce.soap.enterprise.sobject.OrderItem
     */
    private boolean OrderItem__is_set = false;
    ...
    public void setOrderItem(com.sforce.soap.enterprise.sobject.OrderItem OrderItem) {
      ...
      OrderItem__is_set = true;
    }

    protected void setOrderItem(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("OrderItem", "urn:sobject.enterprise.soap.sforce.com","OrderItem","urn:sobject.enterprise.soap.sforce.com","OrderItem",0,1,true))) {
        setOrderItem((com.sforce.soap.enterprise.sobject.OrderItem)__typeMapper.readObject(__in, _lookupTypeInfo("OrderItem", "urn:sobject.enterprise.soap.sforce.com","OrderItem","urn:sobject.enterprise.soap.sforce.com","OrderItem",0,1,true), com.sforce.soap.enterprise.sobject.OrderItem.class));
      }
    }

    private void writeFieldOrderItem(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("OrderItem", "urn:sobject.enterprise.soap.sforce.com","OrderItem","urn:sobject.enterprise.soap.sforce.com","OrderItem",0,1,true), OrderItem, OrderItem__is_set);
    }

    /**
     * element : OrderItemId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean OrderItemId__is_set = false;
    ...
    public void setOrderItemId(java.lang.String OrderItemId) {
      ...
      OrderItemId__is_set = true;
    }

    protected void setOrderItemId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("OrderItemId", "urn:sobject.enterprise.soap.sforce.com","OrderItemId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setOrderItemId(__typeMapper.readString(__in, _lookupTypeInfo("OrderItemId", "urn:sobject.enterprise.soap.sforce.com","OrderItemId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldOrderItemId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("OrderItemId", "urn:sobject.enterprise.soap.sforce.com","OrderItemId","urn:enterprise.soap.sforce.com","ID",0,1,true), OrderItemId, OrderItemId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "OrderItemHistory");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldOrderItem(__out, __typeMapper);
      writeFieldOrderItemId(__out, __typeMapper);
    }
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setOrderItem(__in, __typeMapper);
      setOrderItemId(__in, __typeMapper);
    }
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "OrderItem", OrderItem);
      toStringHelper(sb, "OrderItemId", OrderItemId);
    }
