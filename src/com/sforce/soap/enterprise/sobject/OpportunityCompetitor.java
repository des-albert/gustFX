...
public class OpportunityCompetitor extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setCompetitorName(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("CompetitorName", "urn:sobject.enterprise.soap.sforce.com","CompetitorName","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setCompetitorName(__typeMapper.readString(__in, _lookupTypeInfo("CompetitorName", "urn:sobject.enterprise.soap.sforce.com","CompetitorName","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldCompetitorName(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("CompetitorName", "urn:sobject.enterprise.soap.sforce.com","CompetitorName","http://www.w3.org/2001/XMLSchema","string",0,1,true), CompetitorName, CompetitorName__is_set);
    }
    ...
    protected void setStrengths(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Strengths", "urn:sobject.enterprise.soap.sforce.com","Strengths","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setStrengths(__typeMapper.readString(__in, _lookupTypeInfo("Strengths", "urn:sobject.enterprise.soap.sforce.com","Strengths","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldStrengths(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Strengths", "urn:sobject.enterprise.soap.sforce.com","Strengths","http://www.w3.org/2001/XMLSchema","string",0,1,true), Strengths, Strengths__is_set);
    }
    ...
    protected void setWeaknesses(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Weaknesses", "urn:sobject.enterprise.soap.sforce.com","Weaknesses","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setWeaknesses(__typeMapper.readString(__in, _lookupTypeInfo("Weaknesses", "urn:sobject.enterprise.soap.sforce.com","Weaknesses","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldWeaknesses(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Weaknesses", "urn:sobject.enterprise.soap.sforce.com","Weaknesses","http://www.w3.org/2001/XMLSchema","string",0,1,true), Weaknesses, Weaknesses__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldCompetitorName(__out, __typeMapper);
      ...
      writeFieldStrengths(__out, __typeMapper);
      writeFieldSystemModstamp(__out, __typeMapper);
      writeFieldWeaknesses(__out, __typeMapper);
    }

    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setCompetitorName(__in, __typeMapper);
      ...
      setStrengths(__in, __typeMapper);
      setSystemModstamp(__in, __typeMapper);
      setWeaknesses(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "CompetitorName", CompetitorName);
      ...
      toStringHelper(sb, "Strengths", Strengths);
      toStringHelper(sb, "SystemModstamp", SystemModstamp);
      toStringHelper(sb, "Weaknesses", Weaknesses);
    }
