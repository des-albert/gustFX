...
public class Partner extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setAccountFrom(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AccountFrom", "urn:sobject.enterprise.soap.sforce.com","AccountFrom","urn:sobject.enterprise.soap.sforce.com","Account",0,1,true))) {
        setAccountFrom((com.sforce.soap.enterprise.sobject.Account)__typeMapper.readObject(__in, _lookupTypeInfo("AccountFrom", "urn:sobject.enterprise.soap.sforce.com","AccountFrom","urn:sobject.enterprise.soap.sforce.com","Account",0,1,true), com.sforce.soap.enterprise.sobject.Account.class));
      }
    }

    private void writeFieldAccountFrom(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AccountFrom", "urn:sobject.enterprise.soap.sforce.com","AccountFrom","urn:sobject.enterprise.soap.sforce.com","Account",0,1,true), AccountFrom, AccountFrom__is_set);
    }
    ...
    protected void setAccountFromId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AccountFromId", "urn:sobject.enterprise.soap.sforce.com","AccountFromId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setAccountFromId(__typeMapper.readString(__in, _lookupTypeInfo("AccountFromId", "urn:sobject.enterprise.soap.sforce.com","AccountFromId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldAccountFromId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AccountFromId", "urn:sobject.enterprise.soap.sforce.com","AccountFromId","urn:enterprise.soap.sforce.com","ID",0,1,true), AccountFromId, AccountFromId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldAccountFrom(__out, __typeMapper);
      writeFieldAccountFromId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setAccountFrom(__in, __typeMapper);
      setAccountFromId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "AccountFrom", AccountFrom);
      toStringHelper(sb, "AccountFromId", AccountFromId);
