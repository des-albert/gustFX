...
public class ContentFolderMember extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setChildRecord(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ChildRecord", "urn:sobject.enterprise.soap.sforce.com","ChildRecord","urn:sobject.enterprise.soap.sforce.com","ContentDocument",0,1,true))) {
        setChildRecord((com.sforce.soap.enterprise.sobject.ContentDocument)__typeMapper.readObject(__in, _lookupTypeInfo("ChildRecord", "urn:sobject.enterprise.soap.sforce.com","ChildRecord","urn:sobject.enterprise.soap.sforce.com","ContentDocument",0,1,true), com.sforce.soap.enterprise.sobject.ContentDocument.class));
      }
    }

    private void writeFieldChildRecord(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ChildRecord", "urn:sobject.enterprise.soap.sforce.com","ChildRecord","urn:sobject.enterprise.soap.sforce.com","ContentDocument",0,1,true), ChildRecord, ChildRecord__is_set);
    }
    ...
    protected void setChildRecordId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ChildRecordId", "urn:sobject.enterprise.soap.sforce.com","ChildRecordId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setChildRecordId(__typeMapper.readString(__in, _lookupTypeInfo("ChildRecordId", "urn:sobject.enterprise.soap.sforce.com","ChildRecordId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldChildRecordId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ChildRecordId", "urn:sobject.enterprise.soap.sforce.com","ChildRecordId","urn:enterprise.soap.sforce.com","ID",0,1,true), ChildRecordId, ChildRecordId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldChildRecord(__out, __typeMapper);
      writeFieldChildRecordId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setChildRecord(__in, __typeMapper);
      setChildRecordId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "ChildRecord", ChildRecord);
      toStringHelper(sb, "ChildRecordId", ChildRecordId);
