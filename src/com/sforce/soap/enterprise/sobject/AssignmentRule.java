...
public class AssignmentRule extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setActive(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Active", "urn:sobject.enterprise.soap.sforce.com","Active","http://www.w3.org/2001/XMLSchema","boolean",0,1,true))) {
        setActive((java.lang.Boolean)__typeMapper.readObject(__in, _lookupTypeInfo("Active", "urn:sobject.enterprise.soap.sforce.com","Active","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), java.lang.Boolean.class));
      }
    }
    ...
    private void writeFieldActive(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Active", "urn:sobject.enterprise.soap.sforce.com","Active","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), Active, Active__is_set);
    }
