...
public class CaseContactRole extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setCases(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Cases", "urn:sobject.enterprise.soap.sforce.com","Cases","urn:sobject.enterprise.soap.sforce.com","Case",0,1,true))) {
        setCases((com.sforce.soap.enterprise.sobject.Case)__typeMapper.readObject(__in, _lookupTypeInfo("Cases", "urn:sobject.enterprise.soap.sforce.com","Cases","urn:sobject.enterprise.soap.sforce.com","Case",0,1,true), com.sforce.soap.enterprise.sobject.Case.class));
      }
    }
    ...
    private void writeFieldCases(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Cases", "urn:sobject.enterprise.soap.sforce.com","Cases","urn:sobject.enterprise.soap.sforce.com","Case",0,1,true), Cases, Cases__is_set);
    }
    ...
    protected void setCasesId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("CasesId", "urn:sobject.enterprise.soap.sforce.com","CasesId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setCasesId(__typeMapper.readString(__in, _lookupTypeInfo("CasesId", "urn:sobject.enterprise.soap.sforce.com","CasesId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldCasesId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("CasesId", "urn:sobject.enterprise.soap.sforce.com","CasesId","urn:enterprise.soap.sforce.com","ID",0,1,true), CasesId, CasesId__is_set);
    }
