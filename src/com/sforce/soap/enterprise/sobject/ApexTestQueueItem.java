...
public class ApexTestQueueItem extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setTestRunResultId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("TestRunResultId", "urn:sobject.enterprise.soap.sforce.com","TestRunResultId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setTestRunResultId(__typeMapper.readString(__in, _lookupTypeInfo("TestRunResultId", "urn:sobject.enterprise.soap.sforce.com","TestRunResultId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldTestRunResultId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("TestRunResultId", "urn:sobject.enterprise.soap.sforce.com","TestRunResultId","urn:enterprise.soap.sforce.com","ID",0,1,true), TestRunResultId, TestRunResultId__is_set);
    }
