...
public class DataStatistics extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setStatType(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("StatType", "urn:sobject.enterprise.soap.sforce.com","StatType","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setStatType(__typeMapper.readString(__in, _lookupTypeInfo("StatType", "urn:sobject.enterprise.soap.sforce.com","StatType","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldStatType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("StatType", "urn:sobject.enterprise.soap.sforce.com","StatType","http://www.w3.org/2001/XMLSchema","string",0,1,true), StatType, StatType__is_set);
    }
    ...
    protected void setStatValue(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("StatValue", "urn:sobject.enterprise.soap.sforce.com","StatValue","http://www.w3.org/2001/XMLSchema","int",0,1,true))) {
        setStatValue((java.lang.Integer)__typeMapper.readObject(__in, _lookupTypeInfo("StatValue", "urn:sobject.enterprise.soap.sforce.com","StatValue","http://www.w3.org/2001/XMLSchema","int",0,1,true), java.lang.Integer.class));
      }
    }

    private void writeFieldStatValue(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("StatValue", "urn:sobject.enterprise.soap.sforce.com","StatValue","http://www.w3.org/2001/XMLSchema","int",0,1,true), StatValue, StatValue__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldStatType(__out, __typeMapper);
      writeFieldStatValue(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setStatType(__in, __typeMapper);
      setStatValue(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "StatType", StatType);
      toStringHelper(sb, "StatValue", StatValue);
