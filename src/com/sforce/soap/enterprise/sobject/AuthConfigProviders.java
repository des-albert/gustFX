...
public class AuthConfigProviders extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setAuthConfig(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AuthConfig", "urn:sobject.enterprise.soap.sforce.com","AuthConfig","urn:sobject.enterprise.soap.sforce.com","AuthConfig",0,1,true))) {
        setAuthConfig((com.sforce.soap.enterprise.sobject.AuthConfig)__typeMapper.readObject(__in, _lookupTypeInfo("AuthConfig", "urn:sobject.enterprise.soap.sforce.com","AuthConfig","urn:sobject.enterprise.soap.sforce.com","AuthConfig",0,1,true), com.sforce.soap.enterprise.sobject.AuthConfig.class));
      }
    }

    private void writeFieldAuthConfig(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AuthConfig", "urn:sobject.enterprise.soap.sforce.com","AuthConfig","urn:sobject.enterprise.soap.sforce.com","AuthConfig",0,1,true), AuthConfig, AuthConfig__is_set);
    }
    ...
    protected void setAuthConfigId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AuthConfigId", "urn:sobject.enterprise.soap.sforce.com","AuthConfigId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setAuthConfigId(__typeMapper.readString(__in, _lookupTypeInfo("AuthConfigId", "urn:sobject.enterprise.soap.sforce.com","AuthConfigId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldAuthConfigId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AuthConfigId", "urn:sobject.enterprise.soap.sforce.com","AuthConfigId","urn:enterprise.soap.sforce.com","ID",0,1,true), AuthConfigId, AuthConfigId__is_set);
    }

    /**
     * element : AuthProvider of type {urn:sobject.enterprise.soap.sforce.com}sObject
    ...
    protected void setAuthProvider(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AuthProvider", "urn:sobject.enterprise.soap.sforce.com","AuthProvider","urn:sobject.enterprise.soap.sforce.com","sObject",0,1,true))) {
        setAuthProvider((com.sforce.soap.enterprise.sobject.SObject)__typeMapper.readObject(__in, _lookupTypeInfo("AuthProvider", "urn:sobject.enterprise.soap.sforce.com","AuthProvider","urn:sobject.enterprise.soap.sforce.com","sObject",0,1,true), com.sforce.soap.enterprise.sobject.SObject.class));
      }
    }
    ...
    private void writeFieldAuthProvider(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AuthProvider", "urn:sobject.enterprise.soap.sforce.com","AuthProvider","urn:sobject.enterprise.soap.sforce.com","sObject",0,1,true), AuthProvider, AuthProvider__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldAuthConfig(__out, __typeMapper);
      writeFieldAuthConfigId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setAuthConfig(__in, __typeMapper);
      setAuthConfigId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "AuthConfig", AuthConfig);
      toStringHelper(sb, "AuthConfigId", AuthConfigId);
