...
public class ProcessDefinition extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setLockType(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LockType", "urn:sobject.enterprise.soap.sforce.com","LockType","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setLockType(__typeMapper.readString(__in, _lookupTypeInfo("LockType", "urn:sobject.enterprise.soap.sforce.com","LockType","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldLockType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LockType", "urn:sobject.enterprise.soap.sforce.com","LockType","http://www.w3.org/2001/XMLSchema","string",0,1,true), LockType, LockType__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldLockType(__out, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "LockType", LockType);
