...
public class CategoryData extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setCategoryNodeId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("CategoryNodeId", "urn:sobject.enterprise.soap.sforce.com","CategoryNodeId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setCategoryNodeId(__typeMapper.readString(__in, _lookupTypeInfo("CategoryNodeId", "urn:sobject.enterprise.soap.sforce.com","CategoryNodeId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldCategoryNodeId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("CategoryNodeId", "urn:sobject.enterprise.soap.sforce.com","CategoryNodeId","urn:enterprise.soap.sforce.com","ID",0,1,true), CategoryNodeId, CategoryNodeId__is_set);
    }
    ...
    protected void setRelatedSobjectId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("RelatedSobjectId", "urn:sobject.enterprise.soap.sforce.com","RelatedSobjectId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setRelatedSobjectId(__typeMapper.readString(__in, _lookupTypeInfo("RelatedSobjectId", "urn:sobject.enterprise.soap.sforce.com","RelatedSobjectId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldRelatedSobjectId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("RelatedSobjectId", "urn:sobject.enterprise.soap.sforce.com","RelatedSobjectId","urn:enterprise.soap.sforce.com","ID",0,1,true), RelatedSobjectId, RelatedSobjectId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldCategoryNodeId(__out, __typeMapper);
      ...
      writeFieldRelatedSobjectId(__out, __typeMapper);
      writeFieldSystemModstamp(__out, __typeMapper);
    }

    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setCategoryNodeId(__in, __typeMapper);
      ...
      setRelatedSobjectId(__in, __typeMapper);
      setSystemModstamp(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "CategoryNodeId", CategoryNodeId);
      ...
      toStringHelper(sb, "RelatedSobjectId", RelatedSobjectId);
