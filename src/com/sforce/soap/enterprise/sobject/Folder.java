...
public class Folder extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setAccessType(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("AccessType", "urn:sobject.enterprise.soap.sforce.com","AccessType","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setAccessType(__typeMapper.readString(__in, _lookupTypeInfo("AccessType", "urn:sobject.enterprise.soap.sforce.com","AccessType","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldAccessType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("AccessType", "urn:sobject.enterprise.soap.sforce.com","AccessType","http://www.w3.org/2001/XMLSchema","string",0,1,true), AccessType, AccessType__is_set);
    }
