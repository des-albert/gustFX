...
public class PartnerRole extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setReverseRole(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ReverseRole", "urn:sobject.enterprise.soap.sforce.com","ReverseRole","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setReverseRole(__typeMapper.readString(__in, _lookupTypeInfo("ReverseRole", "urn:sobject.enterprise.soap.sforce.com","ReverseRole","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldReverseRole(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ReverseRole", "urn:sobject.enterprise.soap.sforce.com","ReverseRole","http://www.w3.org/2001/XMLSchema","string",0,1,true), ReverseRole, ReverseRole__is_set);
    }
