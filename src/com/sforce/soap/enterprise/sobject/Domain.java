...
public class Domain extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setDomainSites(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("DomainSites", "urn:sobject.enterprise.soap.sforce.com","DomainSites","urn:enterprise.soap.sforce.com","QueryResult",0,1,true))) {
        setDomainSites((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("DomainSites", "urn:sobject.enterprise.soap.sforce.com","DomainSites","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.enterprise.QueryResult.class));
      }
    }

    private void writeFieldDomainSites(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("DomainSites", "urn:sobject.enterprise.soap.sforce.com","DomainSites","urn:enterprise.soap.sforce.com","QueryResult",0,1,true), DomainSites, DomainSites__is_set);
    }
    ...
    protected void setDomainType(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("DomainType", "urn:sobject.enterprise.soap.sforce.com","DomainType","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setDomainType(__typeMapper.readString(__in, _lookupTypeInfo("DomainType", "urn:sobject.enterprise.soap.sforce.com","DomainType","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldDomainType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("DomainType", "urn:sobject.enterprise.soap.sforce.com","DomainType","http://www.w3.org/2001/XMLSchema","string",0,1,true), DomainType, DomainType__is_set);
    }
    ...
    protected void setOptionsExternalHttps(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("OptionsExternalHttps", "urn:sobject.enterprise.soap.sforce.com","OptionsExternalHttps","http://www.w3.org/2001/XMLSchema","boolean",0,1,true))) {
        setOptionsExternalHttps((java.lang.Boolean)__typeMapper.readObject(__in, _lookupTypeInfo("OptionsExternalHttps", "urn:sobject.enterprise.soap.sforce.com","OptionsExternalHttps","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), java.lang.Boolean.class));
      }
    }

    private void writeFieldOptionsExternalHttps(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("OptionsExternalHttps", "urn:sobject.enterprise.soap.sforce.com","OptionsExternalHttps","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), OptionsExternalHttps, OptionsExternalHttps__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldDomainSites(__out, __typeMapper);
      writeFieldDomainType(__out, __typeMapper);
      ...
      writeFieldOptionsExternalHttps(__out, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "DomainSites", DomainSites);
      toStringHelper(sb, "DomainType", DomainType);
      ...
      toStringHelper(sb, "OptionsExternalHttps", OptionsExternalHttps);
