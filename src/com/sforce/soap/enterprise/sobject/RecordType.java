...
public class RecordType extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setBusinessProcessId(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("BusinessProcessId", "urn:sobject.enterprise.soap.sforce.com","BusinessProcessId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setBusinessProcessId(__typeMapper.readString(__in, _lookupTypeInfo("BusinessProcessId", "urn:sobject.enterprise.soap.sforce.com","BusinessProcessId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldBusinessProcessId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("BusinessProcessId", "urn:sobject.enterprise.soap.sforce.com","BusinessProcessId","urn:enterprise.soap.sforce.com","ID",0,1,true), BusinessProcessId, BusinessProcessId__is_set);
    }
