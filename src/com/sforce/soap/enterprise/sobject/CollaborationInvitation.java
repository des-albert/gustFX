...
public class CollaborationInvitation extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setInvitedUserEmail(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("InvitedUserEmail", "urn:sobject.enterprise.soap.sforce.com","InvitedUserEmail","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setInvitedUserEmail(__typeMapper.readString(__in, _lookupTypeInfo("InvitedUserEmail", "urn:sobject.enterprise.soap.sforce.com","InvitedUserEmail","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldInvitedUserEmail(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("InvitedUserEmail", "urn:sobject.enterprise.soap.sforce.com","InvitedUserEmail","http://www.w3.org/2001/XMLSchema","string",0,1,true), InvitedUserEmail, InvitedUserEmail__is_set);
    }
    ...
    protected void setInvitedUserEmailNormalized(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("InvitedUserEmailNormalized", "urn:sobject.enterprise.soap.sforce.com","InvitedUserEmailNormalized","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setInvitedUserEmailNormalized(__typeMapper.readString(__in, _lookupTypeInfo("InvitedUserEmailNormalized", "urn:sobject.enterprise.soap.sforce.com","InvitedUserEmailNormalized","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldInvitedUserEmailNormalized(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("InvitedUserEmailNormalized", "urn:sobject.enterprise.soap.sforce.com","InvitedUserEmailNormalized","http://www.w3.org/2001/XMLSchema","string",0,1,true), InvitedUserEmailNormalized, InvitedUserEmailNormalized__is_set);
    }
    ...
    protected void setInviterId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("InviterId", "urn:sobject.enterprise.soap.sforce.com","InviterId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setInviterId(__typeMapper.readString(__in, _lookupTypeInfo("InviterId", "urn:sobject.enterprise.soap.sforce.com","InviterId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldInviterId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("InviterId", "urn:sobject.enterprise.soap.sforce.com","InviterId","urn:enterprise.soap.sforce.com","ID",0,1,true), InviterId, InviterId__is_set);
    }
    ...
    protected void setOptionalMessage(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("OptionalMessage", "urn:sobject.enterprise.soap.sforce.com","OptionalMessage","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setOptionalMessage(__typeMapper.readString(__in, _lookupTypeInfo("OptionalMessage", "urn:sobject.enterprise.soap.sforce.com","OptionalMessage","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldOptionalMessage(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("OptionalMessage", "urn:sobject.enterprise.soap.sforce.com","OptionalMessage","http://www.w3.org/2001/XMLSchema","string",0,1,true), OptionalMessage, OptionalMessage__is_set);
    }
    ...
    protected void setSharedEntityId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("SharedEntityId", "urn:sobject.enterprise.soap.sforce.com","SharedEntityId","urn:enterprise.soap.sforce.com","ID",0,1,true))) {
        setSharedEntityId(__typeMapper.readString(__in, _lookupTypeInfo("SharedEntityId", "urn:sobject.enterprise.soap.sforce.com","SharedEntityId","urn:enterprise.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldSharedEntityId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("SharedEntityId", "urn:sobject.enterprise.soap.sforce.com","SharedEntityId","urn:enterprise.soap.sforce.com","ID",0,1,true), SharedEntityId, SharedEntityId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldInvitedUserEmail(__out, __typeMapper);
      writeFieldInvitedUserEmailNormalized(__out, __typeMapper);
      writeFieldInviterId(__out, __typeMapper);
      ...
      writeFieldOptionalMessage(__out, __typeMapper);
      writeFieldParentId(__out, __typeMapper);
      writeFieldSharedEntityId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setInvitedUserEmail(__in, __typeMapper);
      setInvitedUserEmailNormalized(__in, __typeMapper);
      setInviterId(__in, __typeMapper);
      setLastModifiedBy(__in, __typeMapper);
      setLastModifiedById(__in, __typeMapper);
      setLastModifiedDate(__in, __typeMapper);
      setOptionalMessage(__in, __typeMapper);
      setParentId(__in, __typeMapper);
      setSharedEntityId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "InvitedUserEmail", InvitedUserEmail);
      toStringHelper(sb, "InvitedUserEmailNormalized", InvitedUserEmailNormalized);
      toStringHelper(sb, "InviterId", InviterId);
      ...
      toStringHelper(sb, "OptionalMessage", OptionalMessage);
      toStringHelper(sb, "ParentId", ParentId);
      toStringHelper(sb, "SharedEntityId", SharedEntityId);
