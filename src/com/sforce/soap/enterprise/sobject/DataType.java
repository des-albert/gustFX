...
public class DataType extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setContextServiceDataTypeId(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ContextServiceDataTypeId", "urn:sobject.enterprise.soap.sforce.com","ContextServiceDataTypeId","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setContextServiceDataTypeId(__typeMapper.readString(__in, _lookupTypeInfo("ContextServiceDataTypeId", "urn:sobject.enterprise.soap.sforce.com","ContextServiceDataTypeId","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldContextServiceDataTypeId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ContextServiceDataTypeId", "urn:sobject.enterprise.soap.sforce.com","ContextServiceDataTypeId","http://www.w3.org/2001/XMLSchema","string",0,1,true), ContextServiceDataTypeId, ContextServiceDataTypeId__is_set);
    }
    ...
    protected void setContextWsdlDataTypeId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ContextWsdlDataTypeId", "urn:sobject.enterprise.soap.sforce.com","ContextWsdlDataTypeId","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setContextWsdlDataTypeId(__typeMapper.readString(__in, _lookupTypeInfo("ContextWsdlDataTypeId", "urn:sobject.enterprise.soap.sforce.com","ContextWsdlDataTypeId","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldContextWsdlDataTypeId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ContextWsdlDataTypeId", "urn:sobject.enterprise.soap.sforce.com","ContextWsdlDataTypeId","http://www.w3.org/2001/XMLSchema","string",0,1,true), ContextWsdlDataTypeId, ContextWsdlDataTypeId__is_set);
    }
    ...
    protected void setIsComplex(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("IsComplex", "urn:sobject.enterprise.soap.sforce.com","IsComplex","http://www.w3.org/2001/XMLSchema","boolean",0,1,true))) {
        setIsComplex((java.lang.Boolean)__typeMapper.readObject(__in, _lookupTypeInfo("IsComplex", "urn:sobject.enterprise.soap.sforce.com","IsComplex","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), java.lang.Boolean.class));
      }
    }
    ...
    private void writeFieldIsComplex(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("IsComplex", "urn:sobject.enterprise.soap.sforce.com","IsComplex","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), IsComplex, IsComplex__is_set);
    }
