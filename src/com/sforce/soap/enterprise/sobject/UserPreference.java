...
public class UserPreference extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void setPreference(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Preference", "urn:sobject.enterprise.soap.sforce.com","Preference","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setPreference(__typeMapper.readString(__in, _lookupTypeInfo("Preference", "urn:sobject.enterprise.soap.sforce.com","Preference","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldPreference(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Preference", "urn:sobject.enterprise.soap.sforce.com","Preference","http://www.w3.org/2001/XMLSchema","string",0,1,true), Preference, Preference__is_set);
    }
