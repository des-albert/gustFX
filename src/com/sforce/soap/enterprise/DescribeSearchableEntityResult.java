...
public class DescribeSearchableEntityResult implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setPluralLabel(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("pluralLabel", "urn:enterprise.soap.sforce.com","pluralLabel","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setPluralLabel(__typeMapper.readString(__in, _lookupTypeInfo("pluralLabel", "urn:enterprise.soap.sforce.com","pluralLabel","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldPluralLabel(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("pluralLabel", "urn:enterprise.soap.sforce.com","pluralLabel","http://www.w3.org/2001/XMLSchema","string",1,1,true), pluralLabel, pluralLabel__is_set);
    }
