...
public class DataCategoryGroupSobjectTypePair implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setDataCategoryGroupName(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("dataCategoryGroupName", "urn:enterprise.soap.sforce.com","dataCategoryGroupName","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setDataCategoryGroupName(__typeMapper.readString(__in, _lookupTypeInfo("dataCategoryGroupName", "urn:enterprise.soap.sforce.com","dataCategoryGroupName","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }

    private void writeFieldDataCategoryGroupName(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("dataCategoryGroupName", "urn:enterprise.soap.sforce.com","dataCategoryGroupName","http://www.w3.org/2001/XMLSchema","string",1,1,true), dataCategoryGroupName, dataCategoryGroupName__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldDataCategoryGroupName(__out, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "dataCategoryGroupName", dataCategoryGroupName);
