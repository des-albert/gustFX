...
public class RecordTypeMapping implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setDefaultRecordTypeMapping(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("defaultRecordTypeMapping", "urn:enterprise.soap.sforce.com","defaultRecordTypeMapping","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setDefaultRecordTypeMapping(__typeMapper.readBoolean(__in, _lookupTypeInfo("defaultRecordTypeMapping", "urn:enterprise.soap.sforce.com","defaultRecordTypeMapping","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldDefaultRecordTypeMapping(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("defaultRecordTypeMapping", "urn:enterprise.soap.sforce.com","defaultRecordTypeMapping","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), defaultRecordTypeMapping, defaultRecordTypeMapping__is_set);
    }
    ...
    protected void setLayoutId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("layoutId", "urn:enterprise.soap.sforce.com","layoutId","urn:enterprise.soap.sforce.com","ID",1,1,true))) {
        setLayoutId(__typeMapper.readString(__in, _lookupTypeInfo("layoutId", "urn:enterprise.soap.sforce.com","layoutId","urn:enterprise.soap.sforce.com","ID",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldLayoutId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("layoutId", "urn:enterprise.soap.sforce.com","layoutId","urn:enterprise.soap.sforce.com","ID",1,1,true), layoutId, layoutId__is_set);
    }
    ...
    protected void setMaster(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("master", "urn:enterprise.soap.sforce.com","master","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setMaster(__typeMapper.readBoolean(__in, _lookupTypeInfo("master", "urn:enterprise.soap.sforce.com","master","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldMaster(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("master", "urn:enterprise.soap.sforce.com","master","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), master, master__is_set);
    }
