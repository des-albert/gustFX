...
public class SoqlSubQueryCondition extends com.sforce.soap.enterprise.SoqlWhereCondition {
    ...
    protected void setOperator(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("operator", "urn:enterprise.soap.sforce.com","operator","urn:enterprise.soap.sforce.com","soqlOperator",1,1,true))) {
        setOperator((com.sforce.soap.enterprise.SoqlOperator)__typeMapper.readObject(__in, _lookupTypeInfo("operator", "urn:enterprise.soap.sforce.com","operator","urn:enterprise.soap.sforce.com","soqlOperator",1,1,true), com.sforce.soap.enterprise.SoqlOperator.class));
      }
    }
    ...
    private void writeFieldOperator(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("operator", "urn:enterprise.soap.sforce.com","operator","urn:enterprise.soap.sforce.com","soqlOperator",1,1,true), operator, operator__is_set);
    }
    ...
    protected void setSubQuery(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("subQuery", "urn:enterprise.soap.sforce.com","subQuery","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setSubQuery(__typeMapper.readString(__in, _lookupTypeInfo("subQuery", "urn:enterprise.soap.sforce.com","subQuery","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldSubQuery(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("subQuery", "urn:enterprise.soap.sforce.com","subQuery","http://www.w3.org/2001/XMLSchema","string",1,1,true), subQuery, subQuery__is_set);
    }
