...
public class DescribeSObjects_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setSObjectType(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("sObjectType", "urn:enterprise.soap.sforce.com","sObjectType","http://www.w3.org/2001/XMLSchema","string",0,100,true))) {
        setSObjectType((java.lang.String[])__typeMapper.readObject(__in, _lookupTypeInfo("sObjectType", "urn:enterprise.soap.sforce.com","sObjectType","http://www.w3.org/2001/XMLSchema","string",0,100,true), java.lang.String[].class));
      }
    }
    ...
    private void writeFieldSObjectType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("sObjectType", "urn:enterprise.soap.sforce.com","sObjectType","http://www.w3.org/2001/XMLSchema","string",0,100,true), sObjectType, sObjectType__is_set);
    }
