...
public class DescribeQuickActions_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setQuickActions(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("quickActions", "urn:enterprise.soap.sforce.com","quickActions","http://www.w3.org/2001/XMLSchema","string",0,-1,true))) {
        setQuickActions((java.lang.String[])__typeMapper.readObject(__in, _lookupTypeInfo("quickActions", "urn:enterprise.soap.sforce.com","quickActions","http://www.w3.org/2001/XMLSchema","string",0,-1,true), java.lang.String[].class));
      }
    }
    ...
    private void writeFieldQuickActions(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("quickActions", "urn:enterprise.soap.sforce.com","quickActions","http://www.w3.org/2001/XMLSchema","string",0,-1,true), quickActions, quickActions__is_set);
    }
