...
public class DataCategory implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setChildCategories(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("childCategories", "urn:enterprise.soap.sforce.com","childCategories","urn:enterprise.soap.sforce.com","DataCategory",0,-1,true))) {
        setChildCategories((com.sforce.soap.enterprise.DataCategory[])__typeMapper.readObject(__in, _lookupTypeInfo("childCategories", "urn:enterprise.soap.sforce.com","childCategories","urn:enterprise.soap.sforce.com","DataCategory",0,-1,true), com.sforce.soap.enterprise.DataCategory[].class));
      }
    }

    private void writeFieldChildCategories(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("childCategories", "urn:enterprise.soap.sforce.com","childCategories","urn:enterprise.soap.sforce.com","DataCategory",0,-1,true), childCategories, childCategories__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldChildCategories(__out, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "childCategories", childCategories);
