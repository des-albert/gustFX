...
public class SearchResponse_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setResult(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("result", "urn:enterprise.soap.sforce.com","result","urn:enterprise.soap.sforce.com","SearchResult",1,1,true))) {
        setResult((com.sforce.soap.enterprise.SearchResult)__typeMapper.readObject(__in, _lookupTypeInfo("result", "urn:enterprise.soap.sforce.com","result","urn:enterprise.soap.sforce.com","SearchResult",1,1,true), com.sforce.soap.enterprise.SearchResult.class));
      }
    }
    ...
    private void writeFieldResult(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("result", "urn:enterprise.soap.sforce.com","result","urn:enterprise.soap.sforce.com","SearchResult",1,1,true), result, result__is_set);
    }
