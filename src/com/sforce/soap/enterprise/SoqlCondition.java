...
public class SoqlCondition extends com.sforce.soap.enterprise.SoqlWhereCondition {
    ...
    protected void setValues(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("values", "urn:enterprise.soap.sforce.com","values","http://www.w3.org/2001/XMLSchema","string",1,-1,true))) {
        setValues((java.lang.String[])__typeMapper.readObject(__in, _lookupTypeInfo("values", "urn:enterprise.soap.sforce.com","values","http://www.w3.org/2001/XMLSchema","string",1,-1,true), java.lang.String[].class));
      }
    }
    ...
    private void writeFieldValues(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("values", "urn:enterprise.soap.sforce.com","values","http://www.w3.org/2001/XMLSchema","string",1,-1,true), values, values__is_set);
    }
