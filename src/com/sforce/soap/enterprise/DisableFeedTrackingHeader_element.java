...
public class DisableFeedTrackingHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setDisableFeedTracking(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("disableFeedTracking", "urn:enterprise.soap.sforce.com","disableFeedTracking","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setDisableFeedTracking(__typeMapper.readBoolean(__in, _lookupTypeInfo("disableFeedTracking", "urn:enterprise.soap.sforce.com","disableFeedTracking","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldDisableFeedTracking(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("disableFeedTracking", "urn:enterprise.soap.sforce.com","disableFeedTracking","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), disableFeedTracking, disableFeedTracking__is_set);
    }
