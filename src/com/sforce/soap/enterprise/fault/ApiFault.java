...
public class ApiFault extends com.sforce.ws.SoapFaultException implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setExceptionCode(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("exceptionCode", "urn:fault.enterprise.soap.sforce.com","exceptionCode","urn:fault.enterprise.soap.sforce.com","ExceptionCode",1,1,true))) {
        setExceptionCode((com.sforce.soap.enterprise.fault.ExceptionCode)__typeMapper.readObject(__in, _lookupTypeInfo("exceptionCode", "urn:fault.enterprise.soap.sforce.com","exceptionCode","urn:fault.enterprise.soap.sforce.com","ExceptionCode",1,1,true), com.sforce.soap.enterprise.fault.ExceptionCode.class));
      }
    }
    ...
    private void writeFieldExceptionCode(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("exceptionCode", "urn:fault.enterprise.soap.sforce.com","exceptionCode","urn:fault.enterprise.soap.sforce.com","ExceptionCode",1,1,true), exceptionCode, exceptionCode__is_set);
    }
    ...
    protected void setExceptionMessage(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("exceptionMessage", "urn:fault.enterprise.soap.sforce.com","exceptionMessage","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setExceptionMessage(__typeMapper.readString(__in, _lookupTypeInfo("exceptionMessage", "urn:fault.enterprise.soap.sforce.com","exceptionMessage","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldExceptionMessage(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("exceptionMessage", "urn:fault.enterprise.soap.sforce.com","exceptionMessage","http://www.w3.org/2001/XMLSchema","string",1,1,true), exceptionMessage, exceptionMessage__is_set);
    }
    ...
    protected void setExtendedErrorDetails(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("extendedErrorDetails", "urn:fault.enterprise.soap.sforce.com","extendedErrorDetails","urn:enterprise.soap.sforce.com","ExtendedErrorDetails",0,-1,true))) {
        setExtendedErrorDetails((com.sforce.soap.enterprise.ExtendedErrorDetails[])__typeMapper.readObject(__in, _lookupTypeInfo("extendedErrorDetails", "urn:fault.enterprise.soap.sforce.com","extendedErrorDetails","urn:enterprise.soap.sforce.com","ExtendedErrorDetails",0,-1,true), com.sforce.soap.enterprise.ExtendedErrorDetails[].class));
      }
    }
    ...
    private void writeFieldExtendedErrorDetails(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("extendedErrorDetails", "urn:fault.enterprise.soap.sforce.com","extendedErrorDetails","urn:enterprise.soap.sforce.com","ExtendedErrorDetails",0,-1,true), extendedErrorDetails, extendedErrorDetails__is_set);
    }
