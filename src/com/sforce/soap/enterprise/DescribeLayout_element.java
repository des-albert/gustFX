...
public class DescribeLayout_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setLayoutName(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("layoutName", "urn:enterprise.soap.sforce.com","layoutName","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setLayoutName(__typeMapper.readString(__in, _lookupTypeInfo("layoutName", "urn:enterprise.soap.sforce.com","layoutName","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldLayoutName(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("layoutName", "urn:enterprise.soap.sforce.com","layoutName","http://www.w3.org/2001/XMLSchema","string",1,1,true), layoutName, layoutName__is_set);
    }
