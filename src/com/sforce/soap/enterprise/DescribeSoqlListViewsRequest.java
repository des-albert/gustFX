...
public class DescribeSoqlListViewsRequest implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setListViewParams(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("listViewParams", "urn:enterprise.soap.sforce.com","listViewParams","urn:enterprise.soap.sforce.com","DescribeSoqlListViewParams",1,-1,true))) {
        setListViewParams((com.sforce.soap.enterprise.DescribeSoqlListViewParams[])__typeMapper.readObject(__in, _lookupTypeInfo("listViewParams", "urn:enterprise.soap.sforce.com","listViewParams","urn:enterprise.soap.sforce.com","DescribeSoqlListViewParams",1,-1,true), com.sforce.soap.enterprise.DescribeSoqlListViewParams[].class));
      }
    }
    ...
    private void writeFieldListViewParams(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("listViewParams", "urn:enterprise.soap.sforce.com","listViewParams","urn:enterprise.soap.sforce.com","DescribeSoqlListViewParams",1,-1,true), listViewParams, listViewParams__is_set);
    }
