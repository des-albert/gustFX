...
public class DescribeQuickActionDefaultValue implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setDefaultValue(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("defaultValue", "urn:enterprise.soap.sforce.com","defaultValue","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setDefaultValue(__typeMapper.readString(__in, _lookupTypeInfo("defaultValue", "urn:enterprise.soap.sforce.com","defaultValue","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldDefaultValue(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("defaultValue", "urn:enterprise.soap.sforce.com","defaultValue","http://www.w3.org/2001/XMLSchema","string",1,1,true), defaultValue, defaultValue__is_set);
    }
