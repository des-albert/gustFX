...
public class FieldLayoutComponent extends com.sforce.soap.enterprise.DescribeLayoutComponent {
    ...
    protected void setComponents(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("components", "urn:enterprise.soap.sforce.com","components","urn:enterprise.soap.sforce.com","DescribeLayoutComponent",0,-1,true))) {
        setComponents((com.sforce.soap.enterprise.DescribeLayoutComponent[])__typeMapper.readObject(__in, _lookupTypeInfo("components", "urn:enterprise.soap.sforce.com","components","urn:enterprise.soap.sforce.com","DescribeLayoutComponent",0,-1,true), com.sforce.soap.enterprise.DescribeLayoutComponent[].class));
      }
    }
    ...
    private void writeFieldComponents(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("components", "urn:enterprise.soap.sforce.com","components","urn:enterprise.soap.sforce.com","DescribeLayoutComponent",0,-1,true), components, components__is_set);
    }
    ...
    protected void setFieldType(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("fieldType", "urn:enterprise.soap.sforce.com","fieldType","urn:enterprise.soap.sforce.com","fieldType",1,1,true))) {
        setFieldType((com.sforce.soap.enterprise.FieldType)__typeMapper.readObject(__in, _lookupTypeInfo("fieldType", "urn:enterprise.soap.sforce.com","fieldType","urn:enterprise.soap.sforce.com","fieldType",1,1,true), com.sforce.soap.enterprise.FieldType.class));
      }
    }
    ...
    private void writeFieldFieldType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("fieldType", "urn:enterprise.soap.sforce.com","fieldType","urn:enterprise.soap.sforce.com","fieldType",1,1,true), fieldType, fieldType__is_set);
    }
