...
public class FieldDiff implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setDifference(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("difference", "urn:enterprise.soap.sforce.com","difference","urn:enterprise.soap.sforce.com","differenceType",1,1,true))) {
        setDifference((com.sforce.soap.enterprise.DifferenceType)__typeMapper.readObject(__in, _lookupTypeInfo("difference", "urn:enterprise.soap.sforce.com","difference","urn:enterprise.soap.sforce.com","differenceType",1,1,true), com.sforce.soap.enterprise.DifferenceType.class));
      }
    }

    private void writeFieldDifference(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("difference", "urn:enterprise.soap.sforce.com","difference","urn:enterprise.soap.sforce.com","differenceType",1,1,true), difference, difference__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldDifference(__out, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "difference", difference);
