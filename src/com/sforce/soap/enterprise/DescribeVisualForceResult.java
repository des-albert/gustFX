...
public class DescribeVisualForceResult implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setDomain(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("domain", "urn:enterprise.soap.sforce.com","domain","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setDomain(__typeMapper.readString(__in, _lookupTypeInfo("domain", "urn:enterprise.soap.sforce.com","domain","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldDomain(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("domain", "urn:enterprise.soap.sforce.com","domain","http://www.w3.org/2001/XMLSchema","string",1,1,true), domain, domain__is_set);
    }
