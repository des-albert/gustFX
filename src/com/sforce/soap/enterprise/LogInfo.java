...
public class LogInfo implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setCategory(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("category", "urn:enterprise.soap.sforce.com","category","urn:enterprise.soap.sforce.com","LogCategory",1,1,true))) {
        setCategory((com.sforce.soap.enterprise.LogCategory)__typeMapper.readObject(__in, _lookupTypeInfo("category", "urn:enterprise.soap.sforce.com","category","urn:enterprise.soap.sforce.com","LogCategory",1,1,true), com.sforce.soap.enterprise.LogCategory.class));
      }
    }
    ...
    private void writeFieldCategory(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("category", "urn:enterprise.soap.sforce.com","category","urn:enterprise.soap.sforce.com","LogCategory",1,1,true), category, category__is_set);
    }
    ...
    protected void setLevel(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("level", "urn:enterprise.soap.sforce.com","level","urn:enterprise.soap.sforce.com","LogCategoryLevel",1,1,true))) {
        setLevel((com.sforce.soap.enterprise.LogCategoryLevel)__typeMapper.readObject(__in, _lookupTypeInfo("level", "urn:enterprise.soap.sforce.com","level","urn:enterprise.soap.sforce.com","LogCategoryLevel",1,1,true), com.sforce.soap.enterprise.LogCategoryLevel.class));
      }
    }
    ...
    private void writeFieldLevel(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("level", "urn:enterprise.soap.sforce.com","level","urn:enterprise.soap.sforce.com","LogCategoryLevel",1,1,true), level, level__is_set);
    }
