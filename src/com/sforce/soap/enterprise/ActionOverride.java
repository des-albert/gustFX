...
public class ActionOverride implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setFormFactor(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("formFactor", "urn:enterprise.soap.sforce.com","formFactor","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setFormFactor(__typeMapper.readString(__in, _lookupTypeInfo("formFactor", "urn:enterprise.soap.sforce.com","formFactor","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldFormFactor(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("formFactor", "urn:enterprise.soap.sforce.com","formFactor","http://www.w3.org/2001/XMLSchema","string",1,1,true), formFactor, formFactor__is_set);
    }
    ...
    protected void setIsAvailableInTouch(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("isAvailableInTouch", "urn:enterprise.soap.sforce.com","isAvailableInTouch","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setIsAvailableInTouch(__typeMapper.readBoolean(__in, _lookupTypeInfo("isAvailableInTouch", "urn:enterprise.soap.sforce.com","isAvailableInTouch","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldIsAvailableInTouch(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("isAvailableInTouch", "urn:enterprise.soap.sforce.com","isAvailableInTouch","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), isAvailableInTouch, isAvailableInTouch__is_set);
    }
    ...
    protected void setPageId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("pageId", "urn:enterprise.soap.sforce.com","pageId","urn:enterprise.soap.sforce.com","ID",1,1,true))) {
        setPageId(__typeMapper.readString(__in, _lookupTypeInfo("pageId", "urn:enterprise.soap.sforce.com","pageId","urn:enterprise.soap.sforce.com","ID",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldPageId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("pageId", "urn:enterprise.soap.sforce.com","pageId","urn:enterprise.soap.sforce.com","ID",1,1,true), pageId, pageId__is_set);
    }
