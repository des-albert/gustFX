...
public class DescribeGlobalSObjectResult implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setTriggerable(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("triggerable", "urn:enterprise.soap.sforce.com","triggerable","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setTriggerable(__typeMapper.readBoolean(__in, _lookupTypeInfo("triggerable", "urn:enterprise.soap.sforce.com","triggerable","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }
    ...
    private void writeFieldTriggerable(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("triggerable", "urn:enterprise.soap.sforce.com","triggerable","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), triggerable, triggerable__is_set);
    }
