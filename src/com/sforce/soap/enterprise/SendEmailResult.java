...
public class SendEmailResult implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setErrors(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("errors", "urn:enterprise.soap.sforce.com","errors","urn:enterprise.soap.sforce.com","SendEmailError",0,-1,true))) {
        setErrors((com.sforce.soap.enterprise.SendEmailError[])__typeMapper.readObject(__in, _lookupTypeInfo("errors", "urn:enterprise.soap.sforce.com","errors","urn:enterprise.soap.sforce.com","SendEmailError",0,-1,true), com.sforce.soap.enterprise.SendEmailError[].class));
      }
    }
    ...
    private void writeFieldErrors(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("errors", "urn:enterprise.soap.sforce.com","errors","urn:enterprise.soap.sforce.com","SendEmailError",0,-1,true), errors, errors__is_set);
    }
