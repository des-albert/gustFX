...
/**
 *               Each of the batched
 *                 requests for the 'undeleteObject' web service are of
 *                 this type.    This request identifies the object whose
 *                 deletion has to be repealed.
 *                 @classIdentifier    -  ClassIdentifier is for
 *                 determining the type of object whose
 *                 deletion is being rescinded. The input could be a number
 *                 as                                     defined in one of
 *                 the constant files in SDK or the APIName
 *                 of the class.                                     Eg:-
 ...
 *                 message in the undelete Object webservice operation.
 ...
 *                 requirements.                        
 * 
 * <p>Java class for AgileUndeleteObjectRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileUndeleteObjectRequest">
 *   &lt;complexContent>
...
@XmlType(name = "AgileUndeleteObjectRequest", propOrder = {
    "classIdentifier",
    "objectNumber",
    "warningResolution",
    "options",
...
public class AgileUndeleteObjectRequest {
