 ...
 *                 identifies a calendar.             @reason         -  It
 *                 specifies the reason for exception.             @start
 *                 -  It specifies start date of exception.
 *                 @finish           -  It specifies finish date of
 *                 exception.             @actionType       -  It specifies
 *                 3 update types.           1. add           2. update
 *                 3. delete    @inputParameters  - reserve for future
 *                 features                                  
 * 
 * <p>Java class for AgileUpdateCalendarRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileUpdateCalendarRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileUpdateCalendarRequestType", propOrder = {
    "name",
    "newName",
    "description",
    "enabled",
...
public class AgileUpdateCalendarRequestType {
