...
/**
 *              Each of the batched
 *                 responses for the CheckOutAttachment operation are of
 *                 this type. This response provides information about the
 *                 unique Agile Object             from which the files
 *                 were checked out and also returns the list of files
 *                 checked out by the CheckOutAttachment operation.
 *                 @classIdentifier  - This field refers to the
 *                 classIdentifier of the object
 *                 whose attachments were checked out.
 *                 @ObjectNumber     - It is the unique number of the
 *                 Object whose attachment(s)
 *                 were checked out. Eg:- P00001 would be the value if the
 *                 specified attachments were checked out from that
 *                 particular                                  object
 *                 @files            - Refers to information about the
 *                 files that were checked out.
 *                 Multiple files checked out from a single row are
 *                 returned in                                 the form of
 *                 a zipped file.    @outputParameters -  Optional
 *                 name,value pair for addressing future requirements.    
 * 
 * <p>Java class for AgileCheckOutAttachmentResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileCheckOutAttachmentResponseType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="files" type="{http://xmlns.oracle.com/AgileObjects/Core/Attachment/V1}AgileCheckOutAttachmentResponse" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "AgileCheckOutAttachmentResponseType", propOrder = {
    "classIdentifier",
    "objectNumber",
    "files",
    "outputParameters"
})
public class AgileCheckOutAttachmentResponseType {
    ...
    protected List<AgileCheckOutAttachmentResponse> files;
    @XmlElement(nillable = true)
     ...
     * {@link AgileCheckOutAttachmentResponse }
     * 
     * 
     */
    public List<AgileCheckOutAttachmentResponse> getFiles() {
        if (files == null) {
            files = new ArrayList<AgileCheckOutAttachmentResponse>();
        }
        return this.files;
    }
