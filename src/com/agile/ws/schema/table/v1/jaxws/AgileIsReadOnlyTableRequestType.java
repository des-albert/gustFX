...
/**
 *               Each of the batched
 *                 requests for the 'isReadOnly' web service are of this
 *                 type. This request    identifies the table whose
 *                 read-only status has to be verified.
 *                 @agileTable          -  agileTable is used to identify
 *                 any table in the Agile system, for
 *                 example tables such as Attachment, BOM or coverpage.
 *                 This field is                                     of
 *                 type RequestTableType which has been documented in the
 *                 Table schema.
 *                 @inputParameters -  Optional name,value pair for
 *                 addressing future requirement.                   
 * 
 * <p>Java class for AgileIsReadOnlyTableRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileIsReadOnlyTableRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileIsReadOnlyTableRequestType", propOrder = {
    "agileTable",
    "inputParameters"
})
public class AgileIsReadOnlyTableRequestType {
