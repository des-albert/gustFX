...
/**
 *               Each of the batched
 *                 requests for the 'deleteRows' web service are of this
 *                 type.    This request identifies the table that has to
 *                 be deleted.                 @objectInfo          -
 *                 objectInfo is used to identify any table in the Agile
 *                 system from                                     which a
 *                 row will be deleted by the 'deleteRows' web service
 *                 opereation.                                     This
 *                 field is of type RequestTableType which has been
 *                 documented                                     in the
 *                 Table schema.             @rowId               -  Refers
 *                 to the internal rowId of a row belonging to a specific
 *                 table          in which a row has to be deleted. rowID
 *                 identifies a unique row.             @inputParameters
 *                 -  Optional name,value pair for addressing future
 *                 requirement.             
 * 
 * <p>Java class for AgileRemoveRowsRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileRemoveRowsRequest">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="objectInfo" type="{http://xmlns.oracle.com/AgileObjects/Core/Table/V1}RequestTableType"/>
 *         &lt;element name="rowId" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "AgileRemoveRowsRequest", propOrder = {
    "objectInfo",
    "rowId",
    "inputParameters"
})
public class AgileRemoveRowsRequest {

    @XmlElement(required = true, nillable = true)
    protected RequestTableType objectInfo;
    @XmlElement(nillable = true)
    protected List<Integer> rowId;
    @XmlElement(nillable = true)
