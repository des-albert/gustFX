...
/**
 *               Each of the batched
 *                 requests for the 'removeReviewers' web service are of
 *                 this type.             This request specifies the
 ...
 *                 workflow Reviewers will be removed. The input could be a
 *                 number                                      as defined
 ...
 *                 Reviewers are to                                     be
 *                 removeed. The input can be a status number constant or
 *                 an APIName.             @approvers           -  An array
 *                 of users to remove from the Approvers list. Pass null if
 *                 you do not want to remove any approvers.
 *                 @observers           - An array of users to remove from
 *                 the Observers list. Pass null if
 *                 you don't want to remove any observers.
 *                 @acknowledgers       - An array of users to remove from
 *                 the Acknowledgers list. Pass null if
 *                 you don't want to remove any acknowledgers.
 ...
 * 
 * <p>Java class for AgileRemoveReviewersRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileRemoveReviewersRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileRemoveReviewersRequestType", propOrder = {
    "classIdentifier",
    "objectNumber",
    "statusIdentifier",
    "approvers",
...
public class AgileRemoveReviewersRequestType {
