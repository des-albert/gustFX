...
/**
 *                           Request type
 *                 for Approve Routable Object webservice.
 ...
 *                 the approval process.             @notifiers           -
 *                 List of users and user groups to notify
 *                 @escalations         -  Escalations from other users and
 *                 user groups to approve for             @transfers
 *                 -  Transfer from other users and user groups to approve
 *                 for             @approveForGroupList -  List of user
 *                 groups to approve for             @signoffForSelf      -
 *                 Set this to 'true' to signoff for self; false otherwise
 *                 @notifyOriginator    -  Set this to 'true' to notify
 *                 originator; false otherwise    @notifyCCB      -  Set
 *                 this to 'true' to notify CCB; false otherwise
 ...
 * 
 * <p>Java class for AgileApproveRObjectRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileApproveRObjectRequestType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="approveForGroup" type="{http://xmlns.oracle.com/AgileObjects/Core/Common/V1}AgileUserUserGroupIdentifierType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "AgileApproveRObjectRequestType", propOrder = {
    "classIdentifier",
    "objectNumber",
    "password",
    "comment",
...
public class AgileApproveRObjectRequestType {
    ...
    @XmlElement(nillable = true)
    protected List<AgileUserUserGroupIdentifierType> approveForGroup;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the approveForGroup property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the approveForGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getApproveForGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AgileUserUserGroupIdentifierType> getApproveForGroup() {
        if (approveForGroup == null) {
            approveForGroup = new ArrayList<AgileUserUserGroupIdentifierType>();
        }
        return this.approveForGroup;
    }
