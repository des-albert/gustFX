 ...
 *                 you don't want to add any observers.    @acknowledgers
 *                 - An array of users to add to the Acknowledgers list.
 *                 Pass null if                                     you
 *                 don't want to add any acknowledgers.
 ...
 * 
 * <p>Java class for AgileAddReviewersRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileAddReviewersRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileAddReviewersRequestType", propOrder = {
    "classIdentifier",
    "objectNumber",
    "statusIdentifier",
    "approvers",
...
public class AgileAddReviewersRequestType {
