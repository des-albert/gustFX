...
/**
 *               Each of the batched
 *                 requests part of GetApproversRequestType for the
 *                 'getApprovers'             webservice operation are of
 *                 this type. It contains information about the object for
 *                 whose workflow the approvers are to be retrieved.
 *                 @classIdentifier     -  This field is used for
 *                 determining the type of object
 *                 whose approvers are being queried. The input could
 ...
 *                 for which the approver
 *                 list is queried. The input can be a status number
 *                 constant                                     or an
 *                 APIName.    @inputParameters -  Optional name,value pair
 *                 for addressing future requirements.                   
 * 
 * <p>Java class for AgileGetApproversRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileGetApproversRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileGetApproversRequestType", propOrder = {
    "classIdentifier",
    "objectNumber",
    "statusIdentifier",
    "inputParameters"
})
public class AgileGetApproversRequestType {
