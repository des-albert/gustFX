...
/**
 *               Each of the batched
 *                 requests for the 'removeApprovers' web service are of
 *                 this type.             This request specifies the
 *                 details of the approvers to be removed from a workflow
 *                 associated with a partiuclar Agile Object.
 *                 @classIdentifier     -  ClassIdentifier is for
 *                 determining the type of object to whose
 *                 workflow approvers will be removed. The input could be a
 *                 number                                      as defined
 ...
 *                 Determines the desired workflow status from which
 *                 approvers are to                                     be
 *                 removed. The input can be a status number constant or an
 *                 APIName.             @approvers           -  An array of
 *                 users to remove from the Approvers list. Pass null if
 ...
 *                 @comment             - A string providing comments. A
 *                 maximum of 4000 characters is
 *                 permitted.    @inputParameters -  Optional name,value
 *                 pair for addressing future requirements.                   
 * 
 * <p>Java class for AgileRemoveApproversRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileRemoveApproversRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileRemoveApproversRequestType", propOrder = {
    "classIdentifier",
    "objectNumber",
    "statusIdentifier",
    "approvers",
...
public class AgileRemoveApproversRequestType {
