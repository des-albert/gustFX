...
/**
 *              Each of the batched
 *                 responses for the 'rejectROObject' webservice are of
 *                 this type.              This response object contains
 *                 information that identifies the object queried upon
 *                 and the mandatory details for the rejection process.
 ...
 *                 rejection process.             @comment             -  A
 *                 string providing user comments. A maximum length of
 *                 4000 characters is permitted.
 *                 @secondSignature     -  The user's second signature for
 *                 the rejection process.             @notifiers
 *                 -  List of users and user groups to notify
 *                 @escalations         -  Escalations from other users and
 *                 user groups in the
 *                 rejection process.             @transfers           -
 *                 Transfer from other users and user groups in the
 *                 rejection process.                @rejectForGroups     -
 *                 List of user groups to for the rejection process.
 *                 @signoffForSelf      -  Set this to 'true' to signoff
 *                 for self; false otherwise     @notifyOriginator    -
 *                 Set this to 'true' to notify originator; false otherwise
 *                 @notifyCCB      -  Set this to 'true' to notify CCB;
 *                 false otherwise    @notifyChangeAnalyst -  Set this to
 *                 'true' to notify Change Analyst; false otherwise
 *                 @urgent        -  Set this to 'true' to add an icon
 *                 denoting 'urgent' to the mail
 *                 message; Set this to 'false' if this is not needed.
 *                 @inputParameters   -  Optional name,value pair for
 *                 addressing future requirements.         
 * 
 * <p>Java class for AgileRejectRObjectRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileRejectRObjectRequestType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="rejectForGroups" type="{http://xmlns.oracle.com/AgileObjects/Core/Common/V1}AgileUserUserGroupIdentifierType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "AgileRejectRObjectRequestType", propOrder = {
    "classIdentifier",
    "objectNumber",
    "password",
    "comment",
...
public class AgileRejectRObjectRequestType {
    ...
    @XmlElement(nillable = true)
    protected List<AgileUserUserGroupIdentifierType> rejectForGroups;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the rejectForGroups property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the rejectForGroups property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRejectForGroups().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AgileUserUserGroupIdentifierType> getRejectForGroups() {
        if (rejectForGroups == null) {
            rejectForGroups = new ArrayList<AgileUserUserGroupIdentifierType>();
        }
        return this.rejectForGroups;
    }
