...
/**
 *              Response object for
 *                 'getSubClasses' operation. It contains an array of
 *                 elements             named classes, holding a the list
 *                 of classes retrieved by the webservice.
 *                 @classIdentifier     -  Refers to the classType of the
 *                 class whose subclasses are
 *                 returned in the response objects.             @class
 *                 -  A list of classes, each of type ClassType.
 *                 Information                                   regarding
 *                 each class may be retrieved from ClassType.
 *                 @outputParameters -  Optional name,value pair for
 *                 addressing future requirement.          
 * 
 * <p>Java class for AgileGetSubClassesResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileGetSubClassesResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileGetSubClassesResponseType", propOrder = {
    "classIdentifier",
    "classes",
    "outputParameters"
})
public class AgileGetSubClassesResponseType {
