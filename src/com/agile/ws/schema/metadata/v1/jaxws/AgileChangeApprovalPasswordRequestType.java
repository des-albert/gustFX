...
/**
 *          Request object for
 *                 the 'changeApprovalPassword' web service. It contains
 *                 information relating         to the user identifier, the
 *                 old and new passwords using which the approval password
 ...
 *                 @oldPassword       -  The old approval password of the
 *                 current user. The value is set be only if we want
 *                 to reset the current logged-in user's login password.
 *                 The value will be ignored         if userIdentifier is
 *                 set.          @newPassword       -  The new approval
 *                 password of the current user or the one set in
 *                 userIdentifier.                                The value
 *                 set in userIdentifier takes precedence.
 *                 @inputParameters   -  Optional name,value pair for
 *                 addressing future requirements.       
 * 
 * <p>Java class for AgileChangeApprovalPasswordRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileChangeApprovalPasswordRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "AgileChangeApprovalPasswordRequestType", propOrder = {
    "userIdentifier",
    "oldPassword",
    "newPassword",
    "inputParameters"
})
public class AgileChangeApprovalPasswordRequestType {
