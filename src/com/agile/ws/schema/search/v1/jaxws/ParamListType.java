...
/**
 *              @parameter          -
 *                 Parameters for the advanced search operation may be
 *                 passed as a String array.             @dummy
 *                 -  Dummy element which will be ignored by the server. It
 *                 is added to force the generation of
 *                 "ParamListType"
 *                 data type. A few Web Service framework do optimization
 *                 and do not create complex types if they have a single
 *                 element.             
 * 
