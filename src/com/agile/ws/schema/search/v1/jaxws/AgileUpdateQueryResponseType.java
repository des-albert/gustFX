 ...
 *                 @query               -  This contains the results of the
 *                 advanced search operation. The
 *                 results retrieved are of a type common:QueryObjectType
 *                 with the updated parameters.    @outputParameters -
 *                 Optional name,value pair for addressing future
 *                 requirements.             
 * 
 * <p>Java class for AgileUpdateQueryResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgileUpdateQueryResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="query" type="{http://xmlns.oracle.com/AgileObjects/Core/Common/V1}QueryObjectType" minOccurs="0"/>
...
@XmlType(name = "AgileUpdateQueryResponseType", propOrder = {
    "query",
    "outputParameters"
})
public class AgileUpdateQueryResponseType {

    @XmlElement(nillable = true)
    protected QueryObjectType query;
    @XmlElement(nillable = true)
     ...
     *     
     */
    public QueryObjectType getQuery() {
        return query;
    }
     ...
     *     
     */
    public void setQuery(QueryObjectType value) {
        this.query = value;
    }
